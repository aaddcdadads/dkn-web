...
export default {
  ...
  props: {
    ...
    /**
     * 点图层
     * @desc 参考文档：https://lbs.amap.com/api/loca-v2/api#pointlayer
     */
    pointLayers: {
      type: Array, 
      default: function () {
    ...
    /**
     * 线图层
     * @desc 参考文档：https://lbs.amap.com/api/loca-v2/api#linelayer
     */
    lineLayers: {
      type: Array, 
      default: function () {
    ...
    /**
     * 面图层
     * @desc 参考文档：https://lbs.amap.com/api/loca-v2/api#polygonlayer
     */
    polygonLayers: {
      type: Array, 
      default: function () {
  ...
  methods: {
    ...
    loadLayers() {
      ...
      layers.forEach((layer, index) => {
        ...
        let scatter = new Loca.IconLayer(layer.options);
