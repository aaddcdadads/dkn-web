declare module GV  {   class Subject<T> {}
  ...
  class BufferAnalysis {
     ...
     */
    open(type: BufferAnalysisType, range: number, coordinates: Array<GeoPoint>, serverUrl?: string): void;
    /**
     * 关闭分析
     */
    close(): void;
 ...
 */
  class HideAnalysis {
     ...
     * @param serverUrl 服务地址
     */
    open(center: GeoPoint, dis?: number, veilAngle?: number, serverUrl?: string): void;
    private init;
    /**
     * 获取数据
     * @param url
 ...
 */
  class IntervisibilityAnalysis {
     ...
     * @param serverUrl 服务地址
     */
    open(startPoint: GeoPoint, endPoint: GeoPoint, lineWidth?: number, serverUrl?: string): void;
    private init;
    /**
     * 获取数据
     * @param url
 ...
 */
  class PathAnalysis {
     ...
     * @param serverUrl 服务地址
     */
    open(start: GeoPoint, end: GeoPoint, serverUrl?: string): void;
    private init;
    /**
     * 获取数据
     * @param url
 ...
 */
  class PolygonVisiableAnalysis {
     ...
     * @param serverUrl 服务地址
     */
    open(center: GeoPoint, radius?: number, startAngle?: number, endAngle?: number, serverUrl?: string): void;
    private init;
    /**
     * 获取数据
     * @param url
 ...
 */
  class SlopeAnalysis {
     ...
     * 说明：两点为矩形对角线上两点
     */
    open(startPos: GeoPoint, endPos: GeoPoint, serverUrl?: string): void;
    private init;
    /**
     * 创建entity
     * @param dataRes
 ...
 */
 ...
 const gRegister: Register;
  ...
  abstract class DePluginBase {
    ...
    /**
     * 获取当前展示数据的序列化对象,用于系统快照
     */
    abstract getDisplayCondition(): any;
    /**
     * 设置显示数据序列化，用于快照
     * @param  {any} param 数据
     * @param  {boolean} onlyName 用于 综合搜索，综合搜索对插件数据的关键字进行搜索，从综合搜索结果跳转到插件时使用此参数清空其他筛选条件
     */
...
*/
 ...
 let gv: {
    ...
    Path: typeof Path;
    PathModeEnum: typeof PathModeEnum;
    ...
    BufferAnalysisType: typeof BufferAnalysisType;
 ...
 * @类型 外部使用类
 * @描述 动态圆柱几何体
 * @see  <a href='../../../examples/gallery/editor.html#cylinderSensor'>动态圆柱</a>
 */
 ...
 * @类型 外部使用类
 * @描述 动态波纹
 * @see  <a href='../../../examples/gallery/editor.html#dynamicRipple'>动态波纹</a>
 */
 ...
 * @类型 外部使用类
 * @描述 旗子形状的绘制对象
 * @see  <a href='../../../examples/gallery/editor.html#plotEdit'>编辑旗帜</a>
 */
 ...
 */
  ...
  class GraphicItem extends Item {
     ...
     * @param callback 回调函数
     * @描述 为属性更新事件添加回调函数
     * 例如：item.onUpdateAttribute(test)
     * @注意 上例 test 为命名函数，也可以添加命名函数
     */
    onUpdateAttribute(callback: any): void;
    /**
     * @param callback 回调函数
     * @描述 解除属性更新事件添加额回调函数
     * 例如：item.offUpdateAttribute(test)
     * 注意：上例 test 为命名函数，将解除 onUpdateAttribute
     * 绑定的 test 函数，如果需要解除绑定的匿名函数，callback 为空即可
     */
 ...
 * @类型 外部使用类
 * @描述 图标绘制对象
 * @see  <a href='../../../examples/gallery/editor.html#popover'>标签</a>
 */
  class LabelBillboardGraphic extends GraphicItem {
     ...
     * 图标标绘类型
     */
    protected _type: 'LabelBillboardGraphic';
    /**
     * 构造函数
     * @param option 参数对象
     * ```
 ...
 * @see  <a href='../../../examples/gallery/editor.html#popover'>标签</a>
 */
  class LabelRectGraphic extends GraphicItem {
    /**
     * 标绘参数
     */
     ...
     * 图标标绘类型
     */
    protected _type: 'LabelRectGraphic';
    /**
     * 构造函数
     * @param option 参数对象
     * ```
  ...
  class LabelRectGraphicOpt extends GraphicItemOpt {
    /**
     * 位置 lon为经度， lat 为纬度， alt
     * ```
     * 示例代码
 ...
 * @类型 外部使用类
 * @描述 点几何体绘制对象
 * @see  <a href='../../../examples/gallery/editor.html#plottingPoint'>点</a>
 */
 ...
 * @类型 外部使用类
 * @描述 基础面
 * @see  <a href='../../../examples/gallery/editor.html#polygon'>基础面</a>
 */
 ...
 * @类型 外部使用类
 * @描述 雷达扫描波
 * @see  <a href='../../../examples/gallery/editor.html#radar'>雷达扫描波</a>
 */
 ...
 */
  class RectangleGraphicOpt extends GraphicItemOpt {
    ...
    image?: String;
    /**
     * 图片是否透明，仅在 image 有效时有用，默认 false
     */
    transparent?: Boolean;
    /**
     * 是否轮廓
 ...
 * @类型 外部使用类
 * @描述 扫描波
 * @see  <a href='../../../examples/gallery/editor.html#radarScan'>扫描波</a>
 */
 ...
 * @类型 外部使用类
 * @描述 动态扇形几何体
 * @see  <a href='../../../examples/gallery/editor.html#sectorSensor'>扇形动态波</a>
 */
 ...
 * @类型 外部使用类
 * @描述 传感器
 * @see  <a href='../../../examples/gallery/editor.html#sensor'>传感器半径</a>
 */
 ...
 * @类型 外部使用类
 * @描述 扩散波
 * @see  <a href='../../../examples/gallery/editor.html#circleScan'>扩散波</a>
 */
 ...
 * @类型 外部使用类
 * @描述 三角网
 * @see  <a href='../../../examples/gallery/editor.html#efficientTriangles'>空间网</a>
 */
 ...
 * @类型 外部使用类
 * @描述 水面效果
 * @see  <a href='../../../examples/gallery/editor.html#water'>水面效果</a>
 */
 ...
 * @类型 外部使用类
 * @描述 雨、雪模拟
 * @see  <a href='../../../examples/gallery/editor.html#weatherPack'>雨、雪模拟</a>
 */
 ...
 * 图标渲染对象
 */
  class CesiumLabelRect extends RenderObject {
    readonly renderType: RenderTypeEnum;
    /**
     * 初始化
     */
 ...
 */
  ...
  class ConicSensor {
    ...
    private _angle;
    private conicPrimitive;
    private slice;
    private _coverColor;
    private _conicOpt;
    private _swingAngle;
    constructor(conicOpt: ConicOpt);
    /**
     * 获取圆锥primitive
  ...
  class ReactangularSensor {
    ...
    private _swingAngle;
    constructor(rectangularOpt: RectangularOpt);
    /**
     * 获取渲染对象
 ...
 */
  ...
  class SatelliteOpt {
    ...
    /**卫星罩类型 */
    type?: StatelliteEnum;
    constructor(tle: string, orbitColor?: string, orbitTrackColor?: string, groundTrackColor?: string, type?: StatelliteEnum);
}
/**
 * 卫星罩类型枚举
 */
 ...
 */
  ...
  class TargetLayer extends Layer {
     ...
     * @param height 高度
     */
    selectByRectangel(x: number, y: number, width: number, height: number): any[];
    /**
    * 保存图层样式配置信息
  ...
  class TargetPath {
    ...
    * ```
    * 示例代码
    *  let item = new GV.TargetPath(target,)
    * ```
    */
...
/**
 * 图标矢量参数
* 该方法是和icenter配合的特定功能，url当前对外呈现的是wmts的方式接入，不支持其他方式如wms等
 */
  class IconTileOpt {
    /**服务地址 */
    url: string;
 ...
 * @类型 外部使用类
 * @描述 建筑物
 * @see <a href='../../../examples/gallery/editor.html#cityNew'>智慧城市</a>
 */
  class Building {
    /**
     * @readonly
...
/**
  ...
  */
  class PanelOpt {
    /**
     * 面板类型 'sprite' 默认值 标志板类型 'object' 普通三维对象
     */
    panelType?: String;
    /**
     * div对象
 ...
 */
  class LocalSceneManager extends THREE.EventDispatcher {
    ...
    /**
     * 构造函数
     * @param viewer 画布GeoCanvas
     * @param bloomDebug 是否打开Bloom调试面板
     * @param stats 是否打开性能面板
     * @param bloomParams Bloom参数 exposure 曝光度 默认1.7 bloomStrength 辉光强度 默认1.2 bloomThreshold 辉光阈值 默认0 bloomRadius 辉光范围 默认1.0
     * ```
     * 示例代码
     ...
     * 注：object可以是Building/FlyLine/Grass/Lake/ArcFlyLine/DiffusionCircle/Instructions/Panel/Sprite实例，具体参照示例
     * ```
     */
    add(param: any): void;
    /**
