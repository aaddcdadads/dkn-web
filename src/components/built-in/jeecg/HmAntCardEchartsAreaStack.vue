...
export default {
  name: "HmAntCardEchartsAreaStack",
  components: {
  ...
  props: {
    ...
    data: {
      ...
      default: function() {
        return [
          { product: "2021-04-20", sales: 8 },
          { product: "2021-04-21", sales: 2 },
          { product: "2021-04-22", sales: 6 },
          { product: "2021-04-23", sales: 5 },
          { product: "2021-04-24", sales: 4 },
          { product: "2021-04-25", sales: 4 },
          { product: "2021-04-26", sales: 6 },
          { product: "2021-04-27", sales: 8 },
          { product: "2021-04-28", sales: 2 },
          { product: "2021-04-29", sales: 7 }
        ];
      }
    },
    /**
