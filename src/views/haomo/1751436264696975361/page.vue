<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-bg-card ref="titleCard" width="100%" height="100%" border-radius="" box-shadow-v-shadow="" box-shadow-blur="" class="ele-titleCard"> 
            <div class="ele-wrapper ele-wrapper-title">
      <hm-ant-icon-text ref="title" :icon="title.icon" :font-size="title.fontSize" :text="title.text" class="ele-title"> 
       
    </hm-ant-icon-text>
    </div> 
            <div class="ele-wrapper ele-wrapper-isTitle">
      <hm-ant-bg-text ref="isTitle" :text="isTitle.text" :font-size="isTitle.fontSize" :color="isTitle.color"> 
      ...
      <hm-ant-bg-text text="基本信息" font-size="14px" padding="2" class="ele-bf252f1b-c63f-43d8-b3da-2dc087a9f832"> 
      ...
      <hm-ant-bg-text text="活动费用设置(至少一个)" font-size="14px" padding="2" class="ele-42f5eb5a-31b3-4f7a-8ddd-9bb948ae5a17"> 
      ...
      <hm-ant-icon-text ref="deleteText" text="确认删除" icon="" width="272px"> 
      ...
      <hm-bg-card width="100%" height="100%" border-radius="" box-shadow-v-shadow="" box-shadow-blur="" class="ele-ee49ad6d-dd0f-4f85-8ed8-dd1b1b7af98c"> 
      ...
      <hm-ant-table ref="activityImgTableTwo" :columns="activityImgTableTwo.columns" :data="activityImgTableTwo.data" :pagination-hidden="activityImgTableTwo.paginationHidden" :get-data-map="activityImgTableTwo.getDataMap" :actions="activityImgTableTwo.actions" :is-flat-action="activityImgTableTwo.isFlatAction" :row-class-name="activityImgTableTwo.rowClassName" class="ele-activityImgTableTwo"> 
            ...
            <div class="ele-wrapper ele-wrapper-b20c5e06-5a57-4774-a563-47501fbdd9f4">
      <hm-bg-card width="100%" height="100%" border-radius="" box-shadow-v-shadow="" box-shadow-blur="" class="ele-b20c5e06-5a57-4774-a563-47501fbdd9f4"> 
            <div class="ele-wrapper ele-wrapper-1be11cc1-938f-4e91-ba2e-bf92a3fbf648">
      <hm-ant-bg-text text="活动运动信息" font-size="14px" padding="2" class="ele-1be11cc1-938f-4e91-ba2e-bf92a3fbf648"> 
       
    </hm-ant-bg-text>
    </div> 
            <div class="ele-wrapper ele-wrapper-activityExtTwoForm">
      <hm-ant-formily ref="activityExtTwoForm" :config="activityExtTwoForm.config" v-model:value="activityExtTwoForm.value" :col-num="0" :col-min-width="380" :schema="activityExtTwoForm.schema" :label-col="5" :wrapper-col="16" class="ele-activityExtTwoForm"> 
      ...
      <hm-ant-bg-text text="活动信息" font-size="14px" padding="2" class="ele-633b539d-81dc-4e94-af68-dfba9182db48"> 
       
    </hm-ant-bg-text>
    </div> 
            <div class="ele-wrapper ele-wrapper-activityRulesBox">
      <hm-bg-card ref="activityRulesBox" width="100%" height="100%" border-radius="" box-shadow-v-shadow="" box-shadow-blur="" class="ele-activityRulesBox"> 
            <div class="ele-wrapper ele-wrapper-676eaac4-2113-4104-a0d1-6c2704cf0cdb">
      <hm-ant-bg-text text="活动规则：" font-size="14px" padding="2" class="ele-676eaac4-2113-4104-a0d1-6c2704cf0cdb"> 
      ...
      <hm-wang-editor ref="activityRules" v-model:value="activityRules.value" :toolbar-config="activityRules.toolbarConfig" :max-content-length="2" @change="onActivityRulesChange" class="ele-activityRules"> 
            ...
            <div class="ele-wrapper ele-wrapper-agreementCommitmentletterBox">
      <hm-bg-card ref="agreementCommitmentletterBox" width="100%" height="100%" border-radius="" box-shadow-v-shadow="" box-shadow-blur="" class="ele-agreementCommitmentletterBox"> 
            <div class="ele-wrapper ele-wrapper-3e907204-ffc2-4af7-9c91-d488f3bbe726">
      <hm-ant-bg-text text="协议与承诺书：" font-size="14px" padding="2" class="ele-3e907204-ffc2-4af7-9c91-d488f3bbe726"> 
      ...
      <hm-ant-input ref="customerService" v-model:value="customerService.value" title="活动咨询客服" placeholder="" width="480" class="ele-customerService"> 
      ...
      <hm-bg-card ref="message_2" width="100%" height="100%" border-radius="" box-shadow-v-shadow="" box-shadow-blur="" class="ele-message_2"> 
            <div class="ele-wrapper ele-wrapper-fa713d7b-511f-4b6c-9f7a-37b66d33842e">
      <hm-ant-bg-text text="报名页背景设置" font-size="14px" padding="2" class="ele-fa713d7b-511f-4b6c-9f7a-37b66d33842e"> 
      ...
      <hm-modal ref="addBackground" title="报名页背景图" v-model:visible="addBackground.visible" :z-index="1000" height="300px" :auto-close="false" @ok="onAddBackgroundOk" @cancel="onAddBackgroundCancel" class="ele-addBackground"> 
            <div class="ele-wrapper ele-wrapper-activityImgFormOne">
      <hm-ant-formily ref="activityImgFormOne" :config="activityImgFormOne.config" v-model:value="activityImgFormOne.value" :col-num="0" :col-min-width="380" :schema="activityImgFormOne.schema" :label-col="7" :wrapper-col="14"> 
      ...
      <hm-ant-table ref="activityImgTableOne" :columns="activityImgTableOne.columns" :data="activityImgTableOne.data" :pagination-hidden="activityImgTableOne.paginationHidden" :get-data-map="activityImgTableOne.getDataMap" :actions="activityImgTableOne.actions" :is-flat-action="activityImgTableOne.isFlatAction" :row-class-name="activityImgTableOne.rowClassName" class="ele-activityImgTableOne"> 
            ...
            <div class="ele-wrapper ele-wrapper-c4dd580f-87df-48fe-8cd9-1eff76bb10e3">
      <hm-ant-bg-text text="报名页背景颜色设置" font-size="14px" padding="2" class="ele-c4dd580f-87df-48fe-8cd9-1eff76bb10e3"> 
       
    </hm-ant-bg-text>
    </div> 
            <div class="ele-wrapper ele-wrapper-6e5e70a6-798c-41bd-8624-38eb4618518a">
      <hm-bg-card width="100%" height="100%" border-radius="" box-shadow-v-shadow="" box-shadow-blur="" class="ele-6e5e70a6-798c-41bd-8624-38eb4618518a"> 
      ...
      <hm-ant-bg-text text="报名页信息框颜色设置" font-size="14px" padding="2" class="ele-56aec4a5-4b22-4f3e-9572-bd54033fe687"> 
      ...
      <hm-ant-bg-text text="报名页信息框字体颜色设置" font-size="14px" padding="2" class="ele-c9bf9691-385d-414d-864e-a07073520b33"> 
      ...
      <hm-color-kit ref="textColourKit" :color="textColourKit.color" @changecolorkit="onTextColourKitChangecolorkit"> 
            ...
            <div class="ele-wrapper ele-wrapper-610ad32f-244d-4af7-aad8-a7d343ac7d36">
      <hm-ant-bg-text text="活动参与人数信息修改" font-size="14px" padding="2" class="ele-610ad32f-244d-4af7-aad8-a7d343ac7d36"> 
       
    </hm-ant-bg-text>
    </div> 
            <div class="ele-wrapper ele-wrapper-messageRenedit">
      <hm-bg-card ref="messageRenedit" width="100%" height="100%" border-radius="" box-shadow-v-shadow="" box-shadow-blur="" class="ele-messageRenedit"> 
      ...
      <hm-ant-formily ref="activityTwoForm" :config="activityTwoForm.config" v-model:value="activityTwoForm.value" :col-num="0" :col-min-width="380" :schema="activityTwoForm.schema" :label-col="4" :wrapper-col="16" class="ele-activityTwoForm"> 
            ...
            <div class="ele-wrapper ele-wrapper-3e78690d-ccdb-4866-aeb3-c45a66de14fd">
      <hm-bg-card width="100%" height="100%" border-radius="" box-shadow-v-shadow="" box-shadow-blur="" class="ele-3e78690d-ccdb-4866-aeb3-c45a66de14fd"> 
            <div class="ele-wrapper ele-wrapper-acb7b7e7-e364-4d1b-b80c-c68eb0426c4a">
      <hm-ant-bg-text text="报名分享图片设置" font-size="14px" padding="2" class="ele-acb7b7e7-e364-4d1b-b80c-c68eb0426c4a"> 
      ...
      <hm-bg-card ref="isSaveOrUpdate" :box-shadow-blur="isSaveOrUpdate.boxShadowBlur" :hidden="isSaveOrUpdate.hidden" :box-shadow-v-shadow="isSaveOrUpdate.boxShadowVShadow" :border-radius="isSaveOrUpdate.borderRadius" :width="isSaveOrUpdate.width" :height="isSaveOrUpdate.height" :text-align="isSaveOrUpdate.textAlign" class="ele-isSaveOrUpdate"> 
            <div class="ele-wrapper ele-wrapper-be6a0959-060d-4277-9590-2d5ddd2ab12e">
      <hm-ant-button text="修改活动" :type="'primary'" :size="'large'" icon="fa fa-check-circle" @click="onElebe6A0959060D427795902D5Ddd2Ab12EClick" class="ele-be6a0959-060d-4277-9590-2d5ddd2ab12e"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-902e40e8-285f-4e3c-943d-eeafce2cbf7b">
      <hm-ant-button text="重置" :type="'primary'" :size="'large'" :ghost="true" icon="fa fa-repeat" @click="onEle902E40E8285F4E3C943DEeafce2Cbf7BClick" class="ele-902e40e8-285f-4e3c-943d-eeafce2cbf7b"> 
...
.ele-wrapper-6e5e70a6-798c-41bd-8624-38eb4618518a {
  width:100%;
}
