<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-wang-editor ref="activityRules" v-model:value="activityRules.value" :toolbar-config="activityRules.toolbarConfig" :max-content-length="2" class="ele-activityRules"> 
      ...
      <hm-wang-editor ref="agreementCommitmentletter" v-model:value="agreementCommitmentletter.value" :toolbar-config="agreementCommitmentletter.toolbarConfig" :max-content-length="2" class="ele-agreementCommitmentletter"> 
      ...
      <hm-ant-button :ghost="true" :size="'large'" icon="fa fa-repeat" text="重置" :type="'primary'" class="ele-902e40e8-285f-4e3c-943d-eeafce2cbf7b"> 
