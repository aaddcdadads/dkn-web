<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-button ref="addActivityProject" :text="addActivityProject.text" :type="addActivityProject.type" :icon="addActivityProject.icon" :visible="addActivityProject.visible" class="ele-addActivityProject"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-editprice">
      <hm-modal ref="editprice" v-model:visible="editprice.visible" :z-index="1000" class="ele-editprice"> 
    </hm-modal>
    </div> 
      ...
      <hm-ant-button ref="addActivityImgTableTwo" :text="addActivityImgTableTwo.text" :type="addActivityImgTableTwo.type" :icon="addActivityImgTableTwo.icon" :visible="addActivityImgTableTwo.visible" class="ele-addActivityImgTableTwo"> 
      ...
      <hm-ant-button ref="addActivityImgTableOne" :text="addActivityImgTableOne.text" :type="addActivityImgTableOne.type" :icon="addActivityImgTableOne.icon" :visible="addActivityImgTableOne.visible" class="ele-addActivityImgTableOne"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-c0ff8328-d039-4f8a-9041-01e5e385bb58">
      <hm-modal :visible="false" :z-index="1000" class="ele-c0ff8328-d039-4f8a-9041-01e5e385bb58"> 
    </hm-modal>
    </div> 
