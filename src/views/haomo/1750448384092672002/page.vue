<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-formily ref="activityFilter" :config="activityFilter.config" v-model:value="activityFilter.value" :col-num="0" :col-min-width="280" :schema="activityFilter.schema" :label-col="6" :wrapper-col="16" class="ele-activityFilter"> 
      ...
      <hm-bg-card width="100%" height="" border-radius="" :text-align="'right'" padding="" box-shadow-color="#00000000" class="ele-4aad8761-7b58-4d08-b5a2-91fea232f9fe"> 
            <div class="ele-wrapper ele-wrapper-357d4d6e-b124-47f2-a52e-fe3e70eceaf1">
      <hm-ant-button text="批量启用" :type="'primary'" class="ele-357d4d6e-b124-47f2-a52e-fe3e70eceaf1"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-1fe6f16d-9651-4a19-aefd-adf4f60782dc">
      <hm-ant-button text="批量禁用" :type="'primary'" class="ele-1fe6f16d-9651-4a19-aefd-adf4f60782dc"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-c6152b57-61b3-46a7-8557-26437d83e072">
      <hm-ant-button text="批量删除" :type="'primary'" class="ele-c6152b57-61b3-46a7-8557-26437d83e072"> 
      ...
      <hm-modal ref="batchEdit" v-model:visible="batchEdit.visible" width="320px" :z-index="1000" height=""> 
            <div class="ele-wrapper ele-wrapper-prompt">
      <hm-ant-bg-text ref="prompt"> 
