<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-input ref="urlInput" v-model:value="urlInput.value" title="URL" :disabled="true" width="100%" class="ele-urlInput"> 
       
    </hm-ant-input>
    </div> 
            <div class="ele-wrapper ele-wrapper-aea44c0c-2420-4f3f-94f8-b0352515ee1c">
      <hm-ant-button text="复制链接" :type="'primary'" class="ele-aea44c0c-2420-4f3f-94f8-b0352515ee1c"> 
