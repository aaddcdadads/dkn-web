<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-upload ref="viewActivityStoreUpload" title="" text="上传文件" v-model:file-list="viewActivityStoreUpload.fileList" action="/api/dkn/viewActivityStore/importExcel " :headers="viewActivityStoreUpload.headers" class="ele-viewActivityStoreUpload"> 
