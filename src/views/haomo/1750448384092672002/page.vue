<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-panel height="" title="" class="ele-d305a01c-2a94-4341-899d-5e2787dbfd8b"> 
      ...
      <hm-ant-select ref="allStatus" v-model:value="allStatus.value" title="" placeholder="请选择批量操作" v-model:options="allStatus.options" class="ele-allStatus"> 
       
    </hm-ant-select>
    </div> 
            <div class="ele-wrapper ele-wrapper-a9bfb5ef-3877-49fb-a1cf-f095389cbd2e">
      <hm-ant-button text="确认" @click="onElea9Bfb5Ef387749FbA1CfF095389Cbd2EClick" class="ele-a9bfb5ef-3877-49fb-a1cf-f095389cbd2e"> 
