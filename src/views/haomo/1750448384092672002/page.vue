<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-table :columns='[{"title":"门店名称","dataIndex":"storeName","key":"name"},{"title":"所属区域","dataIndex":"region","key":"age","width":80},{"title":"门店地址","dataIndex":"storeAddress","key":"address","ellipsis":true},{"title":"操作","dataIndex":"","key":"action","slots":{"customRender":"action"}}]' :data='[{"storeName":"123"}]' url="/api/dkn/viewActivityStore/list" :params='{"id":"-1"}' :actions='[{"name":"删除","callback":"function (item) {\n                            console.log(\"点击删除: \", item);\n                        }","type":"link"}]' :is-flat-action="true" :row-class-name='{}' class="ele-47d2cd5e-11cb-4b0c-a529-867fb03d6d71"> 
