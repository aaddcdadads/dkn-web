<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-formily ref="activityFilter" :config="activityFilter.config" v-model:value="activityFilter.value" :col-num="2" :col-min-width="380" :schema="activityFilter.schema" :label-col="7" :wrapper-col="14" class="ele-activityFilter"> 
      ...
      <hm-ant-button ref="exportButton" :text="exportButton.text" :type="exportButton.type" :icon="exportButton.icon" :visible="exportButton.visible" @click="onExportButtonClick" class="ele-exportButton"> 
            ...
            <div class="ele-wrapper ele-wrapper-000d61d1-8689-4baf-a071-c6e93f18e109">
      <hm-bg-card width="100%" height="" border-radius="" :text-align="'right'" padding="" box-shadow-color="#00000000" class="ele-000d61d1-8689-4baf-a071-c6e93f18e109"> 
    </hm-bg-card>
    </div> 
            <div class="ele-wrapper ele-wrapper-d305a01c-2a94-4341-899d-5e2787dbfd8b">
      <hm-panel height="" title="活动列表" class="ele-d305a01c-2a94-4341-899d-5e2787dbfd8b"> 
          <template v-slot:slot-title-icon>
        <div class="ele-wrapper ele-wrapper-4aad8761-7b58-4d08-b5a2-91fea232f9fe">
      <hm-bg-card width="100%" height="" border-radius="" :text-align="'right'" padding="" box-shadow-color="#00000000" class="ele-4aad8761-7b58-4d08-b5a2-91fea232f9fe"> 
            <div class="ele-wrapper ele-wrapper-allStatus">
      <hm-ant-select ref="allStatus" v-model:value="allStatus.value" title="" v-model:options="allStatus.options"> 
       
    </hm-ant-select>
    </div> 
            <div class="ele-wrapper ele-wrapper-47ff9558-5bd3-466c-8aac-4895903ffdc1">
      <hm-ant-button text="确认" class="ele-47ff9558-5bd3-466c-8aac-4895903ffdc1"> 
      ...
      <hm-ant-table ref="activityTable" :columns="activityTable.columns" :data="activityTable.data" :pagination="activityTable.pagination" :url="activityTable.url" :params="activityTable.params" :get-data-map="activityTable.getDataMap" :actions="activityTable.actions" :is-flat-action="activityTable.isFlatAction" :background-color="activityTable.backgroundColor" :row-class-name="activityTable.rowClassName" class="ele-activityTable"> 
...
.ele-wrapper-000d61d1-8689-4baf-a071-c6e93f18e109 {
  width:100%;
}
