<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-formily ref="activityFilter" :config="activityFilter.config" v-model:value="activityFilter.value" :col-num="0" :col-min-width="280" :schema="activityFilter.schema" :label-col="5" :wrapper-col="14" class="ele-activityFilter"> 
