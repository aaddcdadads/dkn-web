<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-activity-list ref="activityList" :list="activityList.list" @copyLink="onActivityListCopyLink"> 
      ...
      <hm-modal ref="StoreConfigurationPopupFrame" title="活动门店配置" v-model:visible="StoreConfigurationPopupFrame.visible" :z-index="997" :style="StoreConfigurationPopupFrame.style"> 
      ...
      <hm-ant-button text="批量导入" :type="'primary'" :ghost="true" class="ele-a6d2b6ac-1576-4e40-916d-93f815a9290b"> 
            ...
            <div class="ele-wrapper ele-wrapper-47d2cd5e-11cb-4b0c-a529-867fb03d6d71">
      <hm-ant-table :columns='[{"title":"门店名称","dataIndex":"storeName","key":"name"},{"title":"所属区域","dataIndex":"region","key":"age","width":80},{"title":"门店地址","dataIndex":"storeAddress","key":"address","ellipsis":true},{"title":"操作","dataIndex":"","key":"action","slots":{"customRender":"action"}}]' :data='[]' :actions='[{"name":"编辑","callback":"function (item) {\n                            console.log(\"点击编辑: \", item);\n                        }","type":"link"},{"name":"删除","callback":"function (item) {\n                            console.log(\"点击删除: \", item);\n                        }","type":"link"}]' :row-class-name='{}' class="ele-47d2cd5e-11cb-4b0c-a529-867fb03d6d71"> 
      ...
      <hm-modal ref="addStoreScope" title="添加门店范围" v-model:visible="addStoreScope.visible" :z-index="1000" height=""> 
            <div class="ele-wrapper ele-wrapper-9c35ef61-f1d9-4f5c-a7e0-b1d46e35560d">
      <hm-ant-cascader :value='[]'> 
