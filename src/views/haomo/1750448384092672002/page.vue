<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-button text="批量导入" :type="'primary'" :ghost="true" class="ele-6c6ecbd6-35bf-43b5-bdad-ab23699ef7df"> 
      ...
      <hm-modal ref="addChannelModal" title="添加门店范围" v-model:visible="addChannelModal.visible" :z-index="1000" height="" :auto-close="false"> 
            <div class="ele-wrapper ele-wrapper-97bd2365-db0b-4957-bd65-661e1fdeb3ac">
