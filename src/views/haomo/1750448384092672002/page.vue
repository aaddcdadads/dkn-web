<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-formily ref="activityFilter" :config="activityFilter.config" v-model:value="activityFilter.value" :col-num="2" :schema="activityFilter.schema" :label-col="7" :wrapper-col="14" class="ele-activityFilter"> 
      ...
      <hm-ant-formily ref="activityAddForm" :config="activityAddForm.config" v-model:value="activityAddForm.value" :col-num="2" :schema="activityAddForm.schema" :label-col="7" :wrapper-col="14" class="ele-activityAddForm"> 
      ...
      <hm-ant-formily ref="activityEditForm" :config="activityEditForm.config" v-model:value="activityEditForm.value" :col-num="2" :schema="activityEditForm.schema" :label-col="7" :wrapper-col="14" class="ele-activityEditForm"> 
