  ...
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-bg-text ref="prompt" :text="prompt.text" class="ele-prompt"> 
            ...
            <div class="ele-wrapper ele-wrapper-34b99b14-08e3-4224-9408-e09dcf54e13d">
      <hm-modal title="查看详情" :visible="false" :ok-button-boole="false" cancel-text="关闭" width="810px" :z-index="1000" height="100%"> 
    </hm-modal>
    </div> 
    </hm-bg-card>
    </div>
