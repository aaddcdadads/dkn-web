  ...
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-modal ref="addStoreScope" title="添加门店范围" v-model:visible="addStoreScope.visible" :z-index="1000" height="" :auto-close="false" @ok="onAddStoreScopeOk" @cancel="onAddStoreScopeCancel"> 
            <div class="ele-wrapper ele-wrapper-1e0e60a2-51ce-4b16-a2a2-3b1df6079cf3">
      <hm-ant-tree-select value="undefined" title="" :tree-data='[{"title":"Node1","value":"Node1","key":"0-0","children":[{"title":"Child Node1","value":"Child Node1","key":"0-0-0"}]},{"title":"Node2","value":"Node2","key":"0-1","children":[{"title":"Child Node3","value":"Child Node3","key":"0-1-0","disabled":"true"},{"title":"Child Node4","value":"Child Node4","key":"0-1-1"},{"title":"Child Node5","value":"Child Node5","key":"0-1-2"}]}]' :multiple="true" :tree-checkable="true" @change="onEle1E0E60A251Ce4B16A2A23B1Df6079Cf3Change" class="ele-1e0e60a2-51ce-4b16-a2a2-3b1df6079cf3"> 
    </hm-ant-tree-select>
    </div> 
            <div class="ele-wrapper ele-wrapper-treeSelect">
      <hm-ant-cascader ref="treeSelect" v-model:value="treeSelect.value" title="" :options="treeSelect.options" width="500px" @change="onTreeSelectChange" class="ele-treeSelect"> 
