<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-modal ref="delChannelModal" title="删除" v-model:visible="delChannelModal.visible" :closable="true" :ok-type="'danger'" width="320px" :z-index="1000" height="80px"> 
      ...
      <hm-modal ref="addChannelModal" title="添加门店范围" v-model:visible="addChannelModal.visible" :z-index="1000" height="" :auto-close="false" @cancel="onAddChannelModalCancel"> 
