<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-modal ref="StoreConfigurationPopupFrame" title="活动门店配置" v-model:visible="StoreConfigurationPopupFrame.visible" :closable="true" :cancel-button-props="false" width="720px" :z-index="997" height="" :style="StoreConfigurationPopupFrame.style"> 
      ...
      <hm-ant-button text="批量导入" :type="'primary'" :ghost="true" @click="onElea6D2B6Ac15764E40916D93F815A9290BClick" class="ele-a6d2b6ac-1576-4e40-916d-93f815a9290b"> 
      ...
      <hm-modal ref="viewActivityStoreModal" title="删除" v-model:visible="viewActivityStoreModal.visible" :closable="true" :ok-type="'danger'" width="320px" :z-index="1000" height="80px" @ok="onViewActivityStoreModalOk"> 
            <div class="ele-wrapper ele-wrapper-e3c72123-dab1-4e7d-947b-9cc498196b55">
      <hm-bg-card width="100%" height="" border-radius="" padding="" box-shadow-color="#00000000" class="ele-e3c72123-dab1-4e7d-947b-9cc498196b55"> 
            <div class="ele-wrapper ele-wrapper-20c28b0a-2f8d-4fb4-ae2e-2d5c7ac30af6">
      <hm-ant-bg-text text="是否要删除?" color="#CF2323" :text-align="'left'" padding="0" class="ele-20c28b0a-2f8d-4fb4-ae2e-2d5c7ac30af6"> 
      ...
      <hm-modal ref="addStoreScope" title="添加门店范围" v-model:visible="addStoreScope.visible" :z-index="1000" height="" :auto-close="false" @ok="onAddStoreScopeOk" @cancel="onAddStoreScopeCancel"> 
            <div class="ele-wrapper ele-wrapper-treeSelect">
      <hm-ant-tree-select ref="treeSelect" v-model:value="treeSelect.value" title="" v-model:tree-data="treeSelect.treeData" :multiple="true" :tree-checkable="true" @change="onTreeSelectChange" class="ele-treeSelect"> 
    </hm-ant-tree-select>
    </div> 
            <div class="ele-wrapper ele-wrapper-activityStoreTag">
      <hm-ant-tag ref="activityStoreTag" :title="activityStoreTag.title" :ctag-list="activityStoreTag.ctagList" @close="onActivityStoreTagClose" class="ele-activityStoreTag"> 
      ...
      <hm-modal ref="importantModal" title="导入" v-model:visible="importantModal.visible" :closable="true" ok-text="删除" :ok-button-boole="false" :ok-type="'danger'" :z-index="1000" height="180px"> 
            <div class="ele-wrapper ele-wrapper-797edf01-b948-4ddc-88c5-2278bde7b928">
      <hm-bg-card width="480px" height="180px" border-radius="" :text-align="'center'" padding="" box-shadow-h-shadow="" box-shadow-v-shadow="" box-shadow-blur="" box-shadow-spread="" box-shadow-color="#00000000"> 
            <div class="ele-wrapper ele-wrapper-viewActivityStoreUpload">
      <hm-ant-upload ref="viewActivityStoreUpload" title="" text="上传文件" v-model:file-list="viewActivityStoreUpload.fileList" action="/api/dkn/viewActivityStore/importExcel " :data="viewActivityStoreUpload.data" :headers="viewActivityStoreUpload.headers" @onUploadDone="onViewActivityStoreUploadOnUploadDone" class="ele-viewActivityStoreUpload"> 
       
    </hm-ant-upload>
    </div> 
            <div class="ele-wrapper ele-wrapper-32674f07-f53e-48c8-b937-c9fdc4cde32a">
      <hm-bg-card width="100%" height="" border-radius="" :text-align="'center'" padding="" box-shadow-h-shadow="" box-shadow-v-shadow="" box-shadow-blur="" box-shadow-spread="" box-shadow-color="#00000000" class="ele-32674f07-f53e-48c8-b937-c9fdc4cde32a"> 
            <div class="ele-wrapper ele-wrapper-25a0083f-38cb-436f-af9c-cb74443f0024">
      <hm-ant-bg-text text="仅支持xls、xlsx格式文件  " font-size="16px"> 
       
    </hm-ant-bg-text>
    </div> 
            <div class="ele-wrapper ele-wrapper-476e74cc-7c7d-4b02-b2a5-c7c4317019ee">
      <hm-ant-button text="下载模板" :type="'link'" icon="fa fa-paperclip" @click="onEle476E74Cc7C7D4B02B2A5C7C4317019EeClick" class="ele-476e74cc-7c7d-4b02-b2a5-c7c4317019ee"> 
      ...
      <hm-modal ref="channelModal" title="渠道配置" v-model:visible="channelModal.visible" :closable="true" :cancel-button-props="false" width="720px" :z-index="997" height="" :style="channelModal.style"> 
            <div class="ele-wrapper ele-wrapper-85e440ed-e222-47c9-b9b5-b5da932b435f">
      <hm-bg-card width="100%" height="100%" border-radius="" box-shadow-v-shadow="" box-shadow-blur="" class="ele-85e440ed-e222-47c9-b9b5-b5da932b435f"> 
            <div class="ele-wrapper ele-wrapper-29cecb17-fabb-4ee5-a5b7-512570c6d4b8">
      <hm-ant-button text="新增" :type="'primary'" :ghost="true" @click="onEle29Cecb17Fabb4Ee5A5B7512570C6D4B8Click"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-6c6ecbd6-35bf-43b5-bdad-ab23699ef7df">
      <hm-ant-button text="批量导入" :type="'primary'" :ghost="true" @click="onEle6C6Ecbd635Bf43B5BdadAb23699Ef7DfClick" class="ele-6c6ecbd6-35bf-43b5-bdad-ab23699ef7df"> 
      ...
      <hm-ant-table ref="channelTable" :columns="channelTable.columns" :data="channelTable.data" :url="channelTable.url" :params="channelTable.params" :actions="channelTable.actions" :is-flat-action="channelTable.isFlatAction" :row-class-name="channelTable.rowClassName" class="ele-channelTable"> 
       
    </hm-ant-table>
    </div> 
            <div class="ele-wrapper ele-wrapper-delChannelModal">
      <hm-modal ref="delChannelModal" title="删除" v-model:visible="delChannelModal.visible" :closable="true" :ok-type="'danger'" width="320px" :z-index="1000" height="80px" @ok="onDelChannelModalOk"> 
            <div class="ele-wrapper ele-wrapper-47c9a74e-6fc3-48db-8992-6ce487ba6500">
      <hm-bg-card width="100%" height="" border-radius="" padding="" box-shadow-color="#00000000" class="ele-47c9a74e-6fc3-48db-8992-6ce487ba6500"> 
            <div class="ele-wrapper ele-wrapper-bb41f563-3631-4d69-8120-616a9e58816a">
      <hm-ant-bg-text text="是否要删除?" color="#CF2323" :text-align="'left'" padding="0" class="ele-bb41f563-3631-4d69-8120-616a9e58816a"> 
      ...
      <hm-modal ref="addChannelModal" title="添加门店范围" v-model:visible="addChannelModal.visible" :z-index="1000" height="" :auto-close="false" @ok="onAddChannelModalOk" @cancel="onAddChannelModalCancel"> 
            <div class="ele-wrapper ele-wrapper-channelSelect">
      <hm-ant-select ref="channelSelect" v-model:value="channelSelect.value" url="/api/sys/dict/getDictItem" :params="channelSelect.params" :data-map="channelSelect.dataMap" :mode="'multiple'" v-model:options="channelSelect.options"> 
      ...
      <hm-modal ref="impotChannelModal" title="导入" v-model:visible="impotChannelModal.visible" :closable="true" ok-text="删除" :ok-button-boole="false" :ok-type="'danger'" :z-index="1000" height="180px"> 
            <div class="ele-wrapper ele-wrapper-2f8a2b08-8274-4c92-9dfa-ead59429baa6">
      <hm-bg-card width="480px" height="180px" border-radius="" :text-align="'center'" padding="" box-shadow-h-shadow="" box-shadow-v-shadow="" box-shadow-blur="" box-shadow-spread="" box-shadow-color="#00000000"> 
            <div class="ele-wrapper ele-wrapper-channelUpload">
      <hm-ant-upload ref="channelUpload" title="" text="上传文件" v-model:file-list="channelUpload.fileList" action="/api/dkn/viewActivityDictItem/importExcel " :data="channelUpload.data" :headers="channelUpload.headers" @onUploadDone="onChannelUploadOnUploadDone" class="ele-channelUpload"> 
       
    </hm-ant-upload>
    </div> 
            <div class="ele-wrapper ele-wrapper-8241b2f8-302f-4604-a53c-668ed78c4b87">
      <hm-bg-card width="100%" height="" border-radius="" :text-align="'center'" padding="" box-shadow-h-shadow="" box-shadow-v-shadow="" box-shadow-blur="" box-shadow-spread="" box-shadow-color="#00000000" class="ele-8241b2f8-302f-4604-a53c-668ed78c4b87"> 
            <div class="ele-wrapper ele-wrapper-4de01ecb-90f3-4fb9-b2b5-14d848156621">
      <hm-ant-bg-text text="仅支持xls、xlsx格式文件  " font-size="16px"> 
       
    </hm-ant-bg-text>
    </div> 
            <div class="ele-wrapper ele-wrapper-6a2c4b1b-fc1d-4f9f-9baf-3dc513039ea8">
      <hm-ant-button text="下载模板" :type="'link'" icon="fa fa-paperclip" @click="onEle6A2C4B1BFc1D4F9F9Baf3Dc513039Ea8Click" class="ele-6a2c4b1b-fc1d-4f9f-9baf-3dc513039ea8"> 
...
export default {
  ...
  "activityTable": {
    ...
    "actions": [
      ...
      self.viewActivityStoreUpload.data={activityId:self.activityId}
...
this.importantModal.visible = true;
 ...
 this.addActivityStore()
  ...
  this.$downloadFile("活动门店列表模板.xlsx", "/api/dkn/viewActivityStore/downExcelTemplate", {})
},
  ...
  this.$downloadFile("活动渠道列表模板.xlsx", "/api/dkn/viewActivityDictItem/downExcelTemplate", {})
}
  }
};
</script>
