<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-button ref="bathqiyong" text="批量启用" :type="'primary'" @click="onBathqiyongClick" class="ele-bathqiyong"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-batchBisabled">
      <hm-ant-button ref="batchBisabled" text="批量禁用" :type="'primary'" @click="onBatchBisabledClick" class="ele-batchBisabled"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-batchDelete">
      <hm-ant-button ref="batchDelete" text="批量删除" :type="'primary'" @click="onBatchDeleteClick" class="ele-batchDelete"> 
      ...
      <hm-bg-card width="100%" height="" border-radius="" padding="" box-shadow-color="#00000000" class="ele-b30d54e9-4e74-4c47-b7d3-81f3d36b7f6a"> 
            <div class="ele-wrapper ele-wrapper-a9755570-7ff7-48da-9f8c-afc1b468c786">
      <hm-ant-input value="" title="URL" class="ele-a9755570-7ff7-48da-9f8c-afc1b468c786"> 
      ...
      <hm-bg-card width="100%" height="" border-radius="" padding="" box-shadow-color="#00000000" class="ele-2ec3a6e9-60d5-49a0-8676-03c8bd1a7eec"> 
            <div class="ele-wrapper ele-wrapper-94ca123c-7c72-46ad-8770-3d45ef9f5eb9">
      <hm-ant-bg-text text="二维码：" font-size="16px"> 
       
    </hm-ant-bg-text>
    </div> 
            <div class="ele-wrapper ele-wrapper-d294e5fa-1558-4b84-a792-91c688bcc07f">
      <hm-bg-card width="100%" height="" border-radius="" padding="" box-shadow-color="#00000000" class="ele-d294e5fa-1558-4b84-a792-91c688bcc07f"> 
    </hm-bg-card>
    </div> 
    </hm-bg-card>
    </div> 
