<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-modal ref="addChannelModal" title="添加门店范围" v-model:visible="addChannelModal.visible" :z-index="1000" height="" :auto-close="false"> 
            <div class="ele-wrapper ele-wrapper-channelSelect">
      <hm-ant-select ref="channelSelect" v-model:value="channelSelect.value" url="/api/sys/dict/getDictItem" :params="channelSelect.params" :data-map="channelSelect.dataMap" v-model:options="channelSelect.options" @change="onChannelSelectChange"> 
      ...
      <hm-ant-upload ref="channelUpload" title="" text="上传文件" v-model:file-list="channelUpload.fileList" action="/api/dkn/viewActivityStore/importExcel " :headers="channelUpload.headers" class="ele-channelUpload"> 
      ...
      <hm-ant-button text="下载模板" :type="'link'" icon="fa fa-paperclip" class="ele-6a2c4b1b-fc1d-4f9f-9baf-3dc513039ea8"> 
