<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-modal ref="viewActivityStoreModal" title="删除" v-model:visible="viewActivityStoreModal.visible" :closable="true" :ok-type="'danger'" width="320px" :z-index="1000" height="80px"> 
