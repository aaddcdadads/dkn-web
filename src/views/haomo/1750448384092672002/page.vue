  ...
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-bg-card width="100%" height="" border-radius="" :text-align="'right'" padding="" box-shadow-color="#00000000" class="ele-4aad8761-7b58-4d08-b5a2-91fea232f9fe"> 
            <div class="ele-wrapper ele-wrapper-ef6acbd4-668c-4f2e-a883-67ce884a8791">
      <hm-ant-formily :config='{"channel":{"type":"Select","title":"","style":{"width":"50%"},"props":{"title":"","options":[{"label":"启用","value":1},{"label":"停用","value":2},{"label":"删除","value":3}]},"validator":"function(value) {}"},"search":{"type":"HmAntButton","title":"","style":{"width":"80px","marginLeft":"10px"},"props":{"text":"查询","type":"primary","icon":"fa fa-search"},"events":{"@click":"function(e) {searchRegistrationOrders(self, null);}"},"validator":"function(value) {}"}}' :value='{}' :col-num="0" :col-min-width="380" :label-col="7" :wrapper-col="14" class="ele-ef6acbd4-668c-4f2e-a883-67ce884a8791"> 
