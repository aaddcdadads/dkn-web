<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-bg-text font-size="14px" text="活动运动信息" class="ele-37b100fe-30bf-47b0-9bed-b98bbfebd6f1"> 
      ...
      <hm-modal ref="addBackground" :z-index="1000" v-model:visible="addBackground.visible" title="报名页背景图" height="250px" class="ele-addBackground"> 
            <div class="ele-wrapper ele-wrapper-c55fbae6-544d-46d6-a83a-73b92291b38d">
      <hm-ant-formily :schema='{"type":"object","properties":{"form":{"x-component":"Form","x-component-props":{"wrapper-col":{"span":14},"label-col":{"span":7},"style":{"flexWrap":"wrap","display":"flex"}},"type":"void","properties":{}}}}' :wrapper-col="14" :col-num="0" :label-col="7" :col-min-width="380" :config='{"cycle":{"style":{"width":"100%"},"type":"Input","title":"参考尺寸","required":true,"props":{"placeholder":"请输入"}}," name":{"style":{"width":"100%"},"type":"UploadImage","title":"背景图片","maxCount":1,"listType":"picture-card","required":true,"props":{}}}' :value='{}'> 
      ...
      <hm-ant-bg-text text="报名分享图片设置" font-size="14px" class="ele-428bc034-6551-4c0e-b7c0-36c4e903ac9e"> 
       
    </hm-ant-bg-text>
    </div> 
            <div class="ele-wrapper ele-wrapper-sharingImageSettings">
      <hm-modal ref="sharingImageSettings" v-model:visible="sharingImageSettings.visible" :z-index="1000" height="" class="ele-sharingImageSettings"> 
            <div class="ele-wrapper ele-wrapper-89787e21-f9a9-487d-b055-c327bec09efd">
      <hm-ant-formily :config='{"sortNo":{"style":{"width":"100%"},"type":"InputNumber","title":"排序","required":true,"props":{"placeholder":"活动序号"}},"size":{"style":{"width":"100%"},"type":"Input","title":"参考尺寸","required":true,"props":{}},"imgPath":{"style":{"width":"100%"},"type":"UploadImage","title":"图片","required":true,"props":{"action":"/api/sys/common/upload","accept":".jpg,.png"}}}' :value='{}' :col-num="0" :col-min-width="380" :label-col="7" :wrapper-col="14"> 
