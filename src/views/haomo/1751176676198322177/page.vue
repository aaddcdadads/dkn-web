<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-modal ref="addproject" :z-index="1000" v-model:visible="addproject.visible" title="活动项目" :auto-close="false" height="" @cancel="onAddprojectCancel" @ok="onAddprojectOk" class="ele-addproject"> 
      ...
      <hm-modal ref="deleteproject" :z-index="1000" v-model:visible="deleteproject.visible" title="删除" width="320px" height="" @ok="onDeleteprojectOk" class="ele-deleteproject"> 
      ...
      <hm-bg-card box-shadow-blur="" box-shadow-v-shadow="" border-radius="" width="100%" height="100%" class="ele-aaba946a-d941-4abc-85fe-15bc805b4457"> 
      ...
      <hm-ant-input ref="address" width="480" placeholder="例子：上海市徐汇区" title="活动地址" v-model:value="address.value" class="ele-address"> 
      ...
      <hm-ant-bg-text padding="2" font-size="14px" text="活动核销轮次设置（最多可设置3轮，至少1轮每轮时间段不允许出现重叠）" class="ele-2b650687-b88f-4fe2-a2a3-f29ff7bf53b3"> 
      ...
      <hm-ant-bg-text padding="2" font-size="14px" text="活动奖品设置（可为空）" class="ele-71104b33-c64b-4cf7-9044-51db79ed2874"> 
      ...
      <hm-ant-bg-text text="活动规则：" font-size="14px" :text-align="'right'" padding="2" :enable-html-render="true" class="ele-e422be72-923b-42ad-bef4-7e886c910422"> 
       
    </hm-ant-bg-text>
    </div> 
            <div class="ele-wrapper ele-wrapper-activityRules">
      <hm-wang-editor ref="activityRules" :mode="'simple'" v-model:value="activityRules.value" :toolbar-config="activityRules.toolbarConfig" :editor-config="activityRules.editorConfig" :max-content-length="2" @change="onActivityRulesChange" class="ele-activityRules"> 
      ...
      <hm-bg-card ref="agreementCommitmentletterBox" box-shadow-blur="" box-shadow-v-shadow="" border-radius="" width="100%" height="100%" class="ele-agreementCommitmentletterBox"> 
      ...
      <hm-wang-editor ref="agreementCommitmentletter" v-model:value="agreementCommitmentletter.value" :toolbar-config="agreementCommitmentletter.toolbarConfig" :editor-config="agreementCommitmentletter.editorConfig" :max-content-length="2" @change="onAgreementCommitmentletterChange" class="ele-agreementCommitmentletter"> 
      ...
      <hm-ant-input ref="customerService" width="480" title="活动咨询客服" v-model:value="customerService.value" class="ele-customerService"> 
      ...
      <hm-ant-bg-text padding="2" font-size="14px" text="活动参与人数信息修改" class="ele-cb6694c4-1a06-4212-a50f-7d72ce02ce68"> 
      ...
      <hm-ant-bg-text text="活动规则：" font-size="14px" padding="2" class="ele-7bd3d144-f35d-4dac-aff1-06db6231e523"> 
            ...
            <div class="ele-wrapper ele-wrapper-a8009497-6250-4645-a850-97907cfbdabb">
      <hm-wang-editor value="" :toolbar-config='{"excludeKeys":[],"toolbarKeys":["blockquote","bold","underline","italic","color","bgColor","undo","redo","emotion","insertLink","fullScreen",{"iconSvg":"<svg viewBox=\"0 0 1024 1024\"><path d=\"M959.877 128l0.123 0.123v767.775l-0.123 0.122H64.102l-0.122-0.122V128.123l0.122-0.123h895.775zM960 64H64C28.795 64 0 92.795 0 128v768c0 35.205 28.795 64 64 64h896c35.205 0 64-28.795 64-64V128c0-35.205-28.795-64-64-64zM832 288.01c0 53.023-42.988 96.01-96.01 96.01s-96.01-42.987-96.01-96.01S682.967 192 735.99 192 832 234.988 832 288.01zM896 832H128V704l224.01-384 256 320h64l224.01-192z\"></path></svg>","title":"图片","menuKeys":["insertImage","uploadImage"],"key":"group-image"},"fontSize","fontFamily","lineHeight",{"title":"更多","menuKeys":["through","code","sup","sub","clearStyle"],"key":"group-more-style"},"bulletedList","numberedList","headerSelect",{"title":"对齐","menuKeys":["justifyLeft","justifyRight","justifyCenter","justifyJustify"],"key":"group-justify"},{"title":"缩进","menuKeys":["indent","delIndent"],"key":"group-indent"},"todo","divider","codeBlock","insertTable"]}' :max-content-length="2" class="ele-a8009497-6250-4645-a850-97907cfbdabb"> 
      ...
      <hm-ant-bg-text text="协议与承诺书：" font-size="14px" padding="2" class="ele-8aaf6c3d-4395-402a-a7f3-7c5b3e0dd16a"> 
            ...
            <div class="ele-wrapper ele-wrapper-3ace06d9-2eb5-476d-8846-44435a0adedd">
      <hm-wang-editor value="" :toolbar-config='{"excludeKeys":[],"toolbarKeys":["blockquote","bold","underline","italic","color","bgColor","undo","redo","emotion","insertLink","fullScreen",{"iconSvg":"<svg viewBox=\"0 0 1024 1024\"><path d=\"M959.877 128l0.123 0.123v767.775l-0.123 0.122H64.102l-0.122-0.122V128.123l0.122-0.123h895.775zM960 64H64C28.795 64 0 92.795 0 128v768c0 35.205 28.795 64 64 64h896c35.205 0 64-28.795 64-64V128c0-35.205-28.795-64-64-64zM832 288.01c0 53.023-42.988 96.01-96.01 96.01s-96.01-42.987-96.01-96.01S682.967 192 735.99 192 832 234.988 832 288.01zM896 832H128V704l224.01-384 256 320h64l224.01-192z\"></path></svg>","title":"图片","menuKeys":["insertImage","uploadImage"],"key":"group-image"},"fontSize","fontFamily","lineHeight",{"title":"更多","menuKeys":["through","code","sup","sub","clearStyle"],"key":"group-more-style"},"bulletedList","numberedList","headerSelect",{"title":"对齐","menuKeys":["justifyLeft","justifyRight","justifyCenter","justifyJustify"],"key":"group-justify"},{"title":"缩进","menuKeys":["indent","delIndent"],"key":"group-indent"},"todo","divider","codeBlock","insertTable"]}' :max-content-length="2" class="ele-3ace06d9-2eb5-476d-8846-44435a0adedd"> 
...
export default {
  ...
  "3ace06d9-2eb5-476d-8846-44435a0adedd": {
    "value": "",
    "toolbarConfig": {
      "excludeKeys": [],
      "toolbarKeys": [
...
.ele-wrapper-3ace06d9-2eb5-476d-8846-44435a0adedd {
  width:72%;
/deep/.w-e-scroll{
height:120px;
}
