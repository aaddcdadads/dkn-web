<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-wang-editor ref="activityRules" :mode="'simple'" :max-content-length="2" :editor-config="activityRules.editorConfig" v-model:value="activityRules.value" :toolbar-config="activityRules.toolbarConfig" @change="onActivityRulesChange" class="ele-activityRules"> 
      ...
      <hm-wang-editor ref="agreementCommitmentletter" :max-content-length="2" :editor-config="agreementCommitmentletter.editorConfig" v-model:value="agreementCommitmentletter.value" :toolbar-config="agreementCommitmentletter.toolbarConfig" @change="onAgreementCommitmentletterChange" class="ele-agreementCommitmentletter"> 
