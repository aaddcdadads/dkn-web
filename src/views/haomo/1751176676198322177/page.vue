<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-formily ref="activityForm" :schema="activityForm.schema" :wrapper-col="16" :col-num="0" :label-col="3" :col-min-width="380" :config="activityForm.config" v-model:value="activityForm.value" class="ele-activityForm"> 
      ...
      <hm-modal ref="addprize" title="奖品图片" v-model:visible="addprize.visible" :z-index="1000" height="250px" :auto-close="false" class="ele-addprize"> 
      ...
      <hm-ant-formily ref="activityExtForm" :schema="activityExtForm.schema" :wrapper-col="18" :col-num="0" :label-col="5" :col-min-width="380" :config="activityExtForm.config" v-model:value="activityExtForm.value" class="ele-activityExtForm"> 
      ...
      <hm-modal ref="addBackground" title="报名页背景图" v-model:visible="addBackground.visible" :z-index="1000" height="250px" class="ele-addBackground"> 
