<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-modal ref="addproject" title="添加项目" v-model:visible="addproject.visible" :z-index="1000" height="" :auto-close="false" @ok="onAddprojectOk" @cancel="onAddprojectCancel" class="ele-addproject"> 
