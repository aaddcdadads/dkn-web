<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-bg-text text="活动项目设置（至少一个）" font-size="14px" padding="2" class="ele-42f5eb5a-31b3-4f7a-8ddd-9bb948ae5a17"> 
       
    </hm-ant-bg-text>
    </div> 
            <div class="ele-wrapper ele-wrapper-addBtn1">
      <hm-ant-button ref="addBtn1" text="添加" :type="'primary'" icon="fa fa-plus" @click="onAddBtn1Click" class="ele-addBtn1"> 
      ...
      <hm-ant-button ref="addBtn2" text="添加" :type="'primary'" icon="fa fa-plus" @click="onAddBtn2Click" class="ele-addBtn2"> 
      ...
      <hm-ant-bg-text text="活动运动信息" font-size="14px" padding="2" class="ele-37b100fe-30bf-47b0-9bed-b98bbfebd6f1"> 
      ...
      <hm-bg-card box-shadow-blur="" box-shadow-v-shadow="" border-radius="" width="100%" height="100%" class="ele-d873ccb8-7e59-4395-bcfc-8e2f4e73088a"> 
      ...
      <hm-ant-bg-text text="活动核销轮次设置（最多可设置3轮，至少1轮每轮时间段不允许出现重叠）" font-size="14px" padding="2" class="ele-2b650687-b88f-4fe2-a2a3-f29ff7bf53b3"> 
            ...
            <div class="ele-wrapper ele-wrapper-d1031250-b547-4d76-b4ed-9adb9115eb40">
      <hm-ant-button text="添加" :type="'primary'" icon="fa fa-plus" @click="onEled1031250B5474D76B4Ed9Adb9115Eb40Click" class="ele-d1031250-b547-4d76-b4ed-9adb9115eb40"> 
      ...
      <hm-ant-bg-text text="参与人信息配置（必填）" font-size="14px" padding="2" class="ele-71104b33-c64b-4cf7-9044-51db79ed2874"> 
            ...
            <div class="ele-wrapper ele-wrapper-2a08a42c-a92e-46de-8f8d-b5724cfc40ea">
      <hm-ant-button text="添加" :type="'primary'" icon="fa fa-plus" @click="onEle2A08A42CA92E46De8F8DB5724Cfc40EaClick" class="ele-2a08a42c-a92e-46de-8f8d-b5724cfc40ea"> 
      ...
      <hm-ant-button ref="addBtn3" text="添加" :type="'primary'" icon="fa fa-plus" @click="onAddBtn3Click" class="ele-addBtn3"> 
      ...
      <hm-color-kit ref="bgColourKit" @changecolorkit="onBgColourKitChangecolorkit"> 
      ...
      <hm-color-kit ref="textColourKit" @changecolorkit="onTextColourKitChangecolorkit"> 
      ...
      <hm-ant-formily ref="activityTwoForm" :schema="activityTwoForm.schema" :wrapper-col="16" :col-num="0" :label-col="4" :col-min-width="380" :config="activityTwoForm.config" v-model:value="activityTwoForm.value" class="ele-activityTwoForm"> 
      ...
      <hm-modal ref="sharingImageSettings" :z-index="1000" v-model:visible="sharingImageSettings.visible" title="分享图片" :auto-close="false" height="" @cancel="onSharingImageSettingsCancel" @ok="onSharingImageSettingsOk" class="ele-sharingImageSettings"> 
            <div class="ele-wrapper ele-wrapper-activityImgFormTre">
      <hm-ant-formily ref="activityImgFormTre" :schema="activityImgFormTre.schema" :wrapper-col="14" :col-num="0" :label-col="7" :col-min-width="380" :config="activityImgFormTre.config" v-model:value="activityImgFormTre.value"> 
      ...
      <hm-ant-input ref="customerService" v-model:value="customerService.value" title="活动咨询客服" width="480" class="ele-customerService"> 
      ...
      <hm-bg-card width="100%" height="100%" border-radius="" :text-align="'center'" class="ele-cc8ed92e-79cc-488a-9d3f-77d0a2fddce6"> 
      ...
      <hm-ant-button :ghost="true" :size="'large'" icon="fa fa-repeat" text="重置" :type="'primary'" @click="onEleb0A4296243014B4D952505Bfef232B34Click" class="ele-b0a42962-4301-4b4d-9525-05bfef232b34"> 
