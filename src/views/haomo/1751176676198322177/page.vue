<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-bg-text text="协议与承诺：" font-size="14px" class="ele-e422be72-923b-42ad-bef4-7e886c910422"> 
       
    </hm-ant-bg-text>
    </div> 
            <div class="ele-wrapper ele-wrapper-92a3011a-fa3f-40cc-b9ca-0a8958382ca4">
      <hm-wang-editor :mode="'simple'" value="" :toolbar-config='{"toolbarKeys":["blockquote","bold","underline","italic","color","bgColor","undo","redo","emotion","insertLink","fullScreen",{"key":"group-image","title":"图片","iconSvg":"<svg viewBox=\"0 0 1024 1024\"><path d=\"M959.877 128l0.123 0.123v767.775l-0.123 0.122H64.102l-0.122-0.122V128.123l0.122-0.123h895.775zM960 64H64C28.795 64 0 92.795 0 128v768c0 35.205 28.795 64 64 64h896c35.205 0 64-28.795 64-64V128c0-35.205-28.795-64-64-64zM832 288.01c0 53.023-42.988 96.01-96.01 96.01s-96.01-42.987-96.01-96.01S682.967 192 735.99 192 832 234.988 832 288.01zM896 832H128V704l224.01-384 256 320h64l224.01-192z\"></path></svg>","menuKeys":["insertImage","uploadImage"]},"fontSize","fontFamily","lineHeight",{"key":"group-more-style","title":"更多","menuKeys":["through","code","sup","sub","clearStyle"]},"bulletedList","numberedList","todo","divider","codeBlock","insertTable","headerSelect",{"key":"group-justify","title":"对齐","menuKeys":["justifyLeft","justifyRight","justifyCenter","justifyJustify"]},{"key":"group-indent","title":"缩进","menuKeys":["indent","delIndent"]}],"excludeKeys":[]}' :editor-config='{"placeholder":"请输入...","readOnly":false,"autoFocus":true,"scroll":true,"height":"300px","MENU_CONF":{"uploadImage":{"server":"/api/upload","fieldName":"file","headers":{}},"uploadVideo":{"server":"/api/upload","fieldName":"file","headers":{}}}}' :max-content-length="2" class="ele-92a3011a-fa3f-40cc-b9ca-0a8958382ca4"> 
      ...
      <hm-ant-bg-text text="协议与承诺书：" font-size="14px" class="ele-04dfcec4-d289-4d3c-a977-7ed5a6ce3822"> 
       
    </hm-ant-bg-text>
    </div> 
            <div class="ele-wrapper ele-wrapper-0303a115-4a17-41e3-b32a-c1d017db3f97">
      <hm-wang-editor value="" :toolbar-config='{"toolbarKeys":["headerSelect","blockquote","bold","underline","italic",{"key":"group-more-style","title":"更多","menuKeys":["through","code","sup","sub","clearStyle"]},"color","bgColor","undo","redo","fontSize","fontFamily","lineHeight","bulletedList","numberedList","todo",{"key":"group-justify","title":"对齐","menuKeys":["justifyLeft","justifyRight","justifyCenter","justifyJustify"]},{"key":"group-indent","title":"缩进","menuKeys":["indent","delIndent"]},"emotion","insertLink",{"key":"group-image","title":"图片","iconSvg":"<svg viewBox=\"0 0 1024 1024\"><path d=\"M959.877 128l0.123 0.123v767.775l-0.123 0.122H64.102l-0.122-0.122V128.123l0.122-0.123h895.775zM960 64H64C28.795 64 0 92.795 0 128v768c0 35.205 28.795 64 64 64h896c35.205 0 64-28.795 64-64V128c0-35.205-28.795-64-64-64zM832 288.01c0 53.023-42.988 96.01-96.01 96.01s-96.01-42.987-96.01-96.01S682.967 192 735.99 192 832 234.988 832 288.01zM896 832H128V704l224.01-384 256 320h64l224.01-192z\"></path></svg>","menuKeys":["insertImage","uploadImage"]},"insertTable","codeBlock","divider","fullScreen"],"excludeKeys":[]}' :max-content-length="2" class="ele-0303a115-4a17-41e3-b32a-c1d017db3f97"> 
      ...
      <hm-ant-input value="" title="活动咨询客服" width="400" class="ele-848e318a-9213-4805-a8d8-7f9b336b01d5"> 
