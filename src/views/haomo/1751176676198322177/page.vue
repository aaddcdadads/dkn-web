<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-bg-text text="活动地址" font-size="14px" padding="2" class="ele-cb320e37-bd6b-4901-9a10-6de43f0b51c9"> 
      ...
      <hm-bg-card width="100%" height="100%" border-radius="" box-shadow-v-shadow="" box-shadow-blur="" class="ele-d873ccb8-7e59-4395-bcfc-8e2f4e73088a"> 
            <div class="ele-wrapper ele-wrapper-50b478d3-db63-4dbe-b2b3-968844df7bfe">
      <hm-ant-input value="" title="活动地址" placeholder="例子：上海市徐汇区" width="480" class="ele-50b478d3-db63-4dbe-b2b3-968844df7bfe"> 
      ...
      <hm-ant-table :actions='[{"name":"编辑","callback":"function (item) {\n                            console.log(\"点击编辑: \", item);\n                        }","type":"link"},{"name":"删除","callback":"function (item) {\n                            console.log(\"点击删除: \", item);\n                        }","type":"link"}]' :is-flat-action="true" :row-class-name='{}'> 
      ...
      <hm-bg-card ref="activityRulesBox" box-shadow-blur="" box-shadow-v-shadow="" border-radius="" width="100%" height="100%" class="ele-activityRulesBox"> 
            <div class="ele-wrapper ele-wrapper-e422be72-923b-42ad-bef4-7e886c910422">
      <hm-ant-bg-text padding="2" font-size="14px" text="活动规则：" :text-align="'right'" :enable-html-render="true" class="ele-e422be72-923b-42ad-bef4-7e886c910422"> 
      ...
      <hm-ant-bg-text padding="2" font-size="14px" text="协议与承诺书：" class="ele-04dfcec4-d289-4d3c-a977-7ed5a6ce3822"> 
      ...
      <hm-modal ref="addBackground" title="报名页背景图" v-model:visible="addBackground.visible" width="600" :z-index="1000" height="" :auto-close="false" :style="addBackground.style" @ok="onAddBackgroundOk" @cancel="onAddBackgroundCancel" class="ele-addBackground"> 
            <div class="ele-wrapper ele-wrapper-activityImgFormOne">
      <hm-ant-formily ref="activityImgFormOne" :config="activityImgFormOne.config" v-model:value="activityImgFormOne.value" :col-num="0" :col-min-width="380" :schema="activityImgFormOne.schema" :label-col="7" :wrapper-col="14" class="ele-activityImgFormOne"> 
      ...
      <hm-ant-bg-text text="报名页背景颜色设置" font-size="14px" padding="2" class="ele-d785c5c4-1020-487d-9d7c-c7a32ae8a48b"> 
      ...
      <hm-ant-bg-text text="活动参与人数信息修改" font-size="14px" padding="2" class="ele-cb6694c4-1a06-4212-a50f-7d72ce02ce68"> 
      ...
      <hm-ant-button text="创建活动" :type="'primary'" :size="'large'" icon="fa fa-check-circle" @click="onEle78Fb256892504A78987DC766B916F771Click" class="ele-78fb2568-9250-4a78-987d-c766b916f771"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-b0a42962-4301-4b4d-9525-05bfef232b34">
      <hm-ant-button text="重置" :type="'primary'" :size="'large'" :ghost="true" icon="fa fa-repeat" @click="onEleb0A4296243014B4D952505Bfef232B34Click" class="ele-b0a42962-4301-4b4d-9525-05bfef232b34"> 
...
export default {
  ...
  "50b478d3-db63-4dbe-b2b3-968844df7bfe": {
    "value": ""
  },
  "activityImgTableOne": {
    "columns": [
