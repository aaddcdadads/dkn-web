<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-wang-editor ref="activityRules" :mode="'simple'" :max-content-length="2" :editor-config="activityRules.editorConfig" v-model:value="activityRules.value" :toolbar-config="activityRules.toolbarConfig" class="ele-activityRules"> 
      ...
      <hm-wang-editor ref="agreementCommitmentletter" :max-content-length="2" :editor-config="agreementCommitmentletter.editorConfig" v-model:value="agreementCommitmentletter.value" :toolbar-config="agreementCommitmentletter.toolbarConfig" class="ele-agreementCommitmentletter"> 
      ...
      <hm-bg-card box-shadow-blur="" box-shadow-v-shadow="" border-radius="" width="100%" height="100%" class="ele-6cde1a8d-1302-438c-b680-233060f55136"> 
            <div class="ele-wrapper ele-wrapper-4f84b811-ac2f-437a-ae0d-f8123514bb0c">
      <hm-color-kit> 
