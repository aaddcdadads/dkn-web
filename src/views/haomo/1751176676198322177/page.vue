<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-table :is-flat-action="true" :get-data-map='{"total":"","list":""}' :data='[]' :columns='[{"dataIndex":"verificationround","title":"核销轮次","key":"verificationround"},{"dataIndex":"roundname","title":"轮次名称","key":"roundname"},{"dataIndex":"verifiabletime","title":"可核销时间段","key":"verifiabletime"},{"slots":{"customRender":"action"},"dataIndex":"","title":"操作","key":"action"}]' :row-class-name='{}' :actions='[{"name":"编辑","callback":"function (item) {\n                            console.log(\"点击编辑: \", item);\n                        }","type":"link"},{"name":"删除","callback":"function (item) {\n                            console.log(\"点击删除: \", item);\n                        }","type":"link"}]'> 
      ...
      <hm-ant-table ref="activityImgTableOne" :is-flat-action="activityImgTableOne.isFlatAction" :get-data-map="activityImgTableOne.getDataMap" :data="activityImgTableOne.data" :columns="activityImgTableOne.columns" :row-class-name="activityImgTableOne.rowClassName" :pagination-hidden="activityImgTableOne.paginationHidden" :actions="activityImgTableOne.actions" class="ele-activityImgTableOne"> 
