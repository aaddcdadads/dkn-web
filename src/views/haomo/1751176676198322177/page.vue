  ...
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-bg-text text="活动参与人数信息修改" font-size="14px" padding="2" class="ele-cb6694c4-1a06-4212-a50f-7d72ce02ce68"> 
            ...
            <div class="ele-wrapper ele-wrapper-c4c21057-7af5-412a-b953-7d860df8d4c6">
      <hm-bg-card width="100%" height="100%" border-radius="" box-shadow-v-shadow="" box-shadow-blur="" class="ele-c4c21057-7af5-412a-b953-7d860df8d4c6"> 
            <div class="ele-wrapper ele-wrapper-9bb4b8dd-492d-464f-8170-93fd783b48f1">
      <hm-ant-formily :config='{"unrealStatus":{"style":{"width":"100%"},"type":"RadioGroup","title":"虚拟人数","required":true,"props":{"options":[{"label":"启用","value":0},{"label":"禁用","value":1}]},"events":{"@change":"function (e) {\n         let item = self.$refs.activityTwoForm.getFormValues()\n          self.$refs.activityTwoForm.config.unrealCount.required = e.target.value == 0 ? true : false\n          setTimeout(() => { \n            self.$refs.activityTwoForm.setFormValues(item)\n          })\n      }"}},"unrealCount":{"style":{"width":"100%"},"type":"InputNumber","title":"活动人数","required":false,"props":{}}}' :value='{"unrealStatus":1}' :col-num="0" :col-min-width="380" :schema='{"type":"object","properties":{"form":{"x-component":"Form","x-component-props":{"wrapper-col":{"span":14},"label-col":{"span":7},"style":{"flexWrap":"wrap","display":"flex"}},"type":"void","properties":{}}}}' :label-col="4" :wrapper-col="16" class="ele-9bb4b8dd-492d-464f-8170-93fd783b48f1"> 
