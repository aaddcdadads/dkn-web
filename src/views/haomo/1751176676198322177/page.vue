<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-modal ref="addBackground" title="报名页背景图" v-model:visible="addBackground.visible" :z-index="1000" height="" :auto-close="false" :style="addBackground.style" @ok="onAddBackgroundOk" @cancel="onAddBackgroundCancel" class="ele-addBackground"> 
