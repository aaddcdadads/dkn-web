  ...
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-bg-card box-shadow-blur="" box-shadow-v-shadow="" border-radius="" width="100%" height="100%" class="ele-81d9459e-4453-4843-b712-3c112a5e0a41"> 
            <div class="ele-wrapper ele-wrapper-ce890d9c-4b0e-45bc-9c6d-308495f93280">
      <hm-markdown-editor text="" :tab-size="2" class="ele-ce890d9c-4b0e-45bc-9c6d-308495f93280"> 
       
    </hm-markdown-editor>
    </div> 
            <div class="ele-wrapper ele-wrapper-8365ca3f-8e04-4cf0-b0da-f66af737ae55">
      <hm-ant-input value="" title="活动咨询与客服" placeholder="" width="500" class="ele-8365ca3f-8e04-4cf0-b0da-f66af737ae55"> 
       
    </hm-ant-input>
    </div> 
            <div class="ele-wrapper ele-wrapper-activityExtForm">
      <hm-ant-formily ref="activityExtForm" :config="activityExtForm.config" v-model:value="activityExtForm.value" :col-num="0" :col-min-width="380" :schema="activityExtForm.schema" :label-col="5" :wrapper-col="18" class="ele-activityExtForm"> 
      ...
      <hm-modal ref="addBackground" title="报名页背景图" v-model:visible="addBackground.visible" :z-index="1000" height="300px" class="ele-addBackground"> 
            <div class="ele-wrapper ele-wrapper-c55fbae6-544d-46d6-a83a-73b92291b38d">
      <hm-ant-formily :config='{"sortNo":{"style":{"width":"100%"},"type":"InputNumber","title":"排序","required":true,"props":{"placeholder":"图片序号"}},"size":{"style":{"width":"100%"},"type":"Input","title":"参考尺寸","required":true,"props":{"placeholder":"请输入"}}," name":{"style":{"width":"100%"},"type":"UploadImage","title":"背景图片","maxCount":1,"listType":"picture-card","required":true,"props":{}}}' :value='{}' :col-num="0" :col-min-width="380" :schema='{"type":"object","properties":{"form":{"x-component":"Form","x-component-props":{"wrapper-col":{"span":14},"label-col":{"span":7},"style":{"flexWrap":"wrap","display":"flex"}},"type":"void","properties":{}}}}' :label-col="7" :wrapper-col="14"> 
      ...
      <hm-ant-bg-text text="报名分享图片设置" font-size="14px" padding="2" class="ele-428bc034-6551-4c0e-b7c0-36c4e903ac9e"> 
       
    </hm-ant-bg-text>
    </div> 
            <div class="ele-wrapper ele-wrapper-sharingImageSettings">
      <hm-modal ref="sharingImageSettings" title="分享图片" v-model:visible="sharingImageSettings.visible" :z-index="1000" height="" class="ele-sharingImageSettings"> 
            <div class="ele-wrapper ele-wrapper-89787e21-f9a9-487d-b055-c327bec09efd">
      <hm-ant-formily :config='{"size":{"style":{"width":"100%"},"type":"Input","title":"参考尺寸","required":true,"props":{}},"imgPath":{"style":{"width":"100%"},"type":"UploadImage","title":"图片","required":true,"props":{"action":"/api/sys/common/upload","accept":".jpg,.png"}}}' :value='{}' :col-num="0" :col-min-width="380" :label-col="7" :wrapper-col="14"> 
...
import HmMarkdownEditor from "/@/components/built-in/jeecg/HmMarkdownEditor.vue";
