  ...
  "viewRegistrationOrdersTable": {
    ...
    "actions": [
      ...
      },
      {
        "name": "编辑",
        "callback": function (item) {
      self.viewRegistrationOrdersEditModal.visible=true;
      self.currentViewRegistrationOrdersId = item.id;
      self.$nextTick(function() {
        self.viewRegistrationOrdersEditForm.value = item;;
      });
    },
        "type": "link"
      },
