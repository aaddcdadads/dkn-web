<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-select ref="activitySelect" v-model:value="activitySelect.value" url="/api/restify/activity/list" :params="activitySelect.params" :data-map="activitySelect.dataMap" title="" placeholder="选择活动" v-model:options="activitySelect.options" :show-search="true" class="ele-activitySelect"> 
