<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-select ref="activitySelect" v-model:value="activitySelect.value" url="/api/restify/activity/list" :params="activitySelect.params" :data-map="activitySelect.dataMap" title="选择活动" placeholder="选择活动" v-model:options="activitySelect.options" :show-search="true" @change="onActivitySelectChange" class="ele-activitySelect"> 
       
    </hm-ant-select>
    </div> 
            <div class="ele-wrapper ele-wrapper-batchRefund">
      <hm-ant-button ref="batchRefund" :text="batchRefund.text" :type="batchRefund.type" :disabled="batchRefund.disabled" @click="onBatchRefundClick" class="ele-batchRefund"> 
      ...
      <hm-modal ref="viewRegistrationOrdersDeleteModal" title="退款" v-model:visible="viewRegistrationOrdersDeleteModal.visible" :closable="true" :ok-type="'danger'" width="320px" :z-index="1000" height="80px" @ok="onViewRegistrationOrdersDeleteModalOk"> 
      ...
      <hm-ant-icon-text ref="deleteUserInputText" text="是否需要退款?" icon="" width="200px" icon-size="0px" color="#CF2323" color-text="#CF2323" :text-align="'left'" padding="0" icon-padding="0" class="ele-deleteUserInputText"> 
      ...
      <hm-modal ref="batchRefundModal" title="批量退款" v-model:visible="batchRefundModal.visible" :closable="true" :ok-type="'danger'" width="320px" :z-index="1000" height="80px" @ok="onBatchRefundModalOk"> 
            <div class="ele-wrapper ele-wrapper-065940be-5461-4e36-aed7-161a8e6a8126">
      <hm-bg-card width="100%" height="" border-radius="" padding="" box-shadow-color="#00000000" class="ele-065940be-5461-4e36-aed7-161a8e6a8126"> 
            <div class="ele-wrapper ele-wrapper-2e951bad-fbd8-4287-ac2f-30edb85629ca">
      <hm-ant-icon-text text="是否需要批量退款?" icon="" width="200px" icon-size="0px" color="#CF2323" color-text="#CF2323" :text-align="'left'" padding="0" icon-padding="0" class="ele-2e951bad-fbd8-4287-ac2f-30edb85629ca"> 
...
export default {
  ...
  "viewRegistrationOrdersTable": {
    ...
    "columns": [
      ...
      if( names.some(item => item !==  data.record.originalPickUpName)){
      	return self.processingColorData(data.text,"#fe8989");
      }
      ...
      return h(
        ...
        [
          h(HmAntButton, {
            disabled: item.record.pickUpStatus == 0 ||
                      item.record.paymentStatus == 1 || item.record.paymentStatus == 2 || !item.record.money  
                        ? true
                        : false,
            text: "退款",
            fontSize: 14,
  ...
  this.processingColorData = function (strs, color) {
        ...
        let hArr = [];
        for (let i = 0; i < strArr.length; i++) {
          hArr.push(h("div", {style: {backgroundColor: color}}, "第" + strNumberArr[i] + "轮:" + strArr[i]));
        }
        return h(
          "div",
          {
  ...
  this.onSelectList = data.selectedRows.filter(item => !(item.pickUpStatus == 0 ||
