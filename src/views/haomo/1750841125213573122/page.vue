<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-icon-text ref="deleteUserInputText" text="是否要退款?" icon="" width="200px" icon-size="0px" color="#CF2323" color-text="#CF2323" :text-align="'left'" padding="0" icon-padding="0" class="ele-deleteUserInputText"> 
