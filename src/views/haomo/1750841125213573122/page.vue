<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-modal ref="viewRegistrationOrdersDeleteModal" title="删除" v-model:visible="viewRegistrationOrdersDeleteModal.visible" :closable="true" :ok-type="'danger'" width="320px" :z-index="1000" height="80px" @ok="onViewRegistrationOrdersDeleteModalOk"> 
      ...
      <hm-ant-icon-text ref="deleteUserInputText" text="是否要退款?" icon="" width="200px" icon-size="0px" color="#CF2323" color-text="#1F1E1E" :text-align="'left'" padding="0" icon-padding="0" class="ele-deleteUserInputText"> 
