<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-formily ref="storeFilter" :config="storeFilter.config" v-model:value="storeFilter.value" :col-num="2" :schema="storeFilter.schema" :label-col="7" :wrapper-col="14" class="ele-storeFilter"> 
      ...
      <hm-ant-formily ref="storeAddForm" :config="storeAddForm.config" v-model:value="storeAddForm.value" :col-num="2" :schema="storeAddForm.schema" :label-col="7" :wrapper-col="14" class="ele-storeAddForm"> 
      ...
      <hm-ant-formily ref="storeEditForm" :config="storeEditForm.config" v-model:value="storeEditForm.value" :col-num="2" :schema="storeEditForm.schema" :label-col="7" :wrapper-col="14" class="ele-storeEditForm"> 
      ...
      <hm-modal ref="storeDetailModal" title="查看详情" v-model:visible="storeDetailModal.visible" :ok-button-boole="false" cancel-text="关闭" width="810px" :z-index="1000" height="100%"> 
      ...
      <hm-ant-formily ref="storeDetailForm" :config="storeDetailForm.config" v-model:value="storeDetailForm.value" :col-num="2" :schema="storeDetailForm.schema" :label-col="7" :wrapper-col="14" class="ele-storeDetailForm"> 
