<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-modal ref="storeDetailModal" title="查看详情" v-model:visible="storeDetailModal.visible" :ok-button-boole="false" cancel-text="导出门店二维码" :cancel-button-props="false" width="600px" :z-index="1000" height="100%"> 
      ...
      <hm-ant-button ref="sureButton" text="确定" :type="'primary'" :size="'large'" class="ele-sureButton"> 
