<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-bg-text text="二维码：" font-size="16px" padding="3" class="ele-6a427e0a-e088-4f10-8f90-062dff49940b"> 
      ...
      <hm-ant-bg-text text="门店名称：" font-size="16px" :text-align="'right'" padding="3" class="ele-9fa6ebb7-26cf-471e-af62-d8b5679ca587"> 
