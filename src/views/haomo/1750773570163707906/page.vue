<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-modal ref="storeDetailModal" title="查看详情" v-model:visible="storeDetailModal.visible" cancel-text="导出门店二维码" width="600px" :z-index="1000" height="100%" class="ele-storeDetailModal"> 
