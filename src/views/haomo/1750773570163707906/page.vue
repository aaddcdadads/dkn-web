<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-formily ref="storeFilter" :config="storeFilter.config" v-model:value="storeFilter.value" :col-num="0" :col-min-width="380" :schema="storeFilter.schema" :label-col="6" :wrapper-col="14" class="ele-storeFilter"> 
      ...
      <hm-ant-button ref="exportButton" :text="exportButton.text" :type="exportButton.type" :icon="exportButton.icon" :visible="exportButton.visible" @click="onExportButtonClick" class="ele-exportButton"> 
            ...
            <div class="ele-wrapper ele-wrapper-366e61cc-8402-4144-a772-fc906182575a">
      <hm-ant-button :visible="false" @click="onEle366E61Cc84024144A772Fc906182575AClick"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-areaButton">
      <hm-ant-button ref="areaButton" @click="onAreaButtonClick" class="ele-areaButton"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-cityButton">
      <hm-ant-button ref="cityButton" @click="onCityButtonClick" class="ele-cityButton"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-68ec1e3a-e7db-413b-a7cc-7a386f743f83">
      <hm-panel height="" title="门店列表" class="ele-68ec1e3a-e7db-413b-a7cc-7a386f743f83"> 
          <template v-slot:slot-title-icon>
        <div class="ele-wrapper ele-wrapper-b26f83d8-788d-4911-b39c-d6db12ade907">
      <hm-bg-card width="100%" height="" border-radius="" :text-align="'right'" padding="" box-shadow-color="#00000000" class="ele-b26f83d8-788d-4911-b39c-d6db12ade907"> 
      ...
      <hm-ant-button ref="batchDelete" :text="batchDelete.text" :type="batchDelete.type" :disabled="batchDelete.disabled" @click="onBatchDeleteClick" class="ele-batchDelete"> 
            ...
            <div class="ele-wrapper ele-wrapper-f087f9b5-c006-41c6-aea1-a22f650dcce6">
      <hm-ant-button text="新增门店" :type="'primary'" icon="fa fa-plus" @click="onElef087F9B5C00641C6Aea1A22F650Dcce6Click" class="ele-f087f9b5-c006-41c6-aea1-a22f650dcce6"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-6cc57d26-7b37-4d79-8a99-1f8e6af5478f">
      <hm-ant-button text="导入门店" :type="'primary'" icon="fa fa-download" @click="onEle6Cc57D267B374D798A991F8E6Af5478FClick" class="ele-6cc57d26-7b37-4d79-8a99-1f8e6af5478f"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-6f9a0599-82dc-4e11-880c-d7f38d3f8892">
      <hm-ant-button text="导出核销码" :type="'primary'" icon="fa fa-download" @click="onEle6F9A059982Dc4E11880CD7F38D3F8892Click" class="ele-6f9a0599-82dc-4e11-880c-d7f38d3f8892"> 
      ...
      <hm-ant-table ref="storeTable" :columns="storeTable.columns" :data="storeTable.data" :pagination="storeTable.pagination" :url="storeTable.url" :params="storeTable.params" :get-data-map="storeTable.getDataMap" :row-select-flag="storeTable.rowSelectFlag" :row-selection="storeTable.rowSelection" :actions="storeTable.actions" :is-flat-action="storeTable.isFlatAction" :background-color="storeTable.backgroundColor" :row-class-name="storeTable.rowClassName" @onSelect="onStoreTableOnSelect" @onSelectAll="onStoreTableOnSelectAll" class="ele-storeTable"> 
      ...
      <hm-modal ref="storeAddModal" title="新增" v-model:visible="storeAddModal.visible" width="810px" :z-index="1000" height="100%" :auto-close="false" @ok="onStoreAddModalOk" @cancel="onStoreAddModalCancel"> 
      ...
      <hm-ant-formily ref="storeAddForm" :config="storeAddForm.config" v-model:value="storeAddForm.value" :col-num="2" :col-min-width="380" :schema="storeAddForm.schema" :label-col="7" :wrapper-col="14" class="ele-storeAddForm"> 
       
    </hm-ant-formily>
    </div> 
            <div class="ele-wrapper ele-wrapper-rcodeTwo">
      <hm-bg-card ref="rcodeTwo" width="100%" height="" border-radius="" padding="" box-shadow-color="#00000000" class="ele-rcodeTwo"> 
    </hm-bg-card>
    </div> 
    </hm-bg-card>
    </div> 
      ...
      <hm-modal ref="storeEditModal" title="编辑" v-model:visible="storeEditModal.visible" width="810px" :z-index="1000" height="100%" :auto-close="false" @ok="onStoreEditModalOk" @cancel="onStoreEditModalCancel"> 
      ...
      <hm-ant-formily ref="storeEditForm" :config="storeEditForm.config" v-model:value="storeEditForm.value" :col-num="2" :col-min-width="380" :schema="storeEditForm.schema" :label-col="7" :wrapper-col="14" class="ele-storeEditForm"> 
      ...
      <hm-modal ref="storeDetailModal" title="门店核销码" v-model:visible="storeDetailModal.visible" :ok-button-boole="false" cancel-text="导出门店二维码" :cancel-button-props="false" width="600px" :z-index="1000" height="100%"> 
      ...
      <hm-ant-bg-text ref="erCode" text="二维码：" font-size="16px" :text-align="'right'" padding="3" class="ele-erCode"> 
      ...
      <hm-bg-card ref="qrcode" width="100%" height="" border-radius="" padding="" box-shadow-color="#00000000" class="ele-qrcode"> 
            ...
            <div class="ele-wrapper ele-wrapper-484bf8ce-7d76-4bf5-bd8b-b64d3ed4b395">
      <hm-bg-card width="100%" height="" border-radius="" padding="" box-shadow-h-shadow="" box-shadow-v-shadow="" box-shadow-blur="" box-shadow-spread="" class="ele-484bf8ce-7d76-4bf5-bd8b-b64d3ed4b395"> 
            <div class="ele-wrapper ele-wrapper-storeName">
      <hm-ant-bg-text ref="storeName" text="门店名称：" font-size="16px" :text-align="'right'" padding="3"> 
       
    </hm-ant-bg-text>
    </div> 
            <div class="ele-wrapper ele-wrapper-storeNameText">
      <hm-ant-bg-text ref="storeNameText" :text="storeNameText.text" :font-size="storeNameText.fontSize"> 
      ...
      <hm-bg-card ref="bottomBg" width="100%" height="" border-radius="" :text-align="'right'" padding="12" box-shadow-color="#00000000" class="ele-bottomBg"> 
            <div class="ele-wrapper ele-wrapper-daochuButton">
      <hm-ant-button ref="daochuButton" text="导出门店二维码" :type="'primary'" :size="'large'" @click="onDaochuButtonClick" class="ele-daochuButton"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-sureButton">
      <hm-ant-button ref="sureButton" text="确定" :type="'primary'" :size="'large'" @click="onSureButtonClick" class="ele-sureButton"> 
      ...
      <hm-modal ref="storeDeleteModal" title="删除" v-model:visible="storeDeleteModal.visible" :closable="true" ok-text="删除" :ok-type="'danger'" width="320px" :z-index="1000" height="80px" @ok="onStoreDeleteModalOk"> 
      ...
      <hm-modal ref="batchEdit" title="批量操作" v-model:visible="batchEdit.visible" width="320px" :z-index="1000" height="" @ok="onBatchEditOk" @cancel="onBatchEditCancel"> 
      ...
      <hm-modal ref="importantModal" title="导入" v-model:visible="importantModal.visible" :closable="true" ok-text="删除" :ok-button-boole="false" :ok-type="'danger'" :z-index="1000" height="180px" @cancel="onImportantModalCancel"> 
            <div class="ele-wrapper ele-wrapper-3735a4cb-1c0b-4050-807c-5780659b7ddc">
      <hm-bg-card width="480px" height="180px" border-radius="" :text-align="'center'" padding="" box-shadow-h-shadow="" box-shadow-v-shadow="" box-shadow-blur="" box-shadow-spread="" box-shadow-color="#00000000"> 
            <div class="ele-wrapper ele-wrapper-9cec9dc8-fe98-4620-bc41-f3bf45e728fc">
      <hm-ant-upload title="" text="上传文件" :file-list='[]' action="/api/dkn/store/importExcel " :headers='{}' @onUploadDone="onEle9Cec9Dc8Fe984620Bc41F3Bf45E728FcOnUploadDone" class="ele-9cec9dc8-fe98-4620-bc41-f3bf45e728fc"> 
       
    </hm-ant-upload>
    </div> 
            <div class="ele-wrapper ele-wrapper-a160ebb9-189f-4350-b467-2689abf84e5e">
      <hm-bg-card width="100%" height="" border-radius="" :text-align="'center'" padding="" box-shadow-h-shadow="" box-shadow-v-shadow="" box-shadow-blur="" box-shadow-spread="" box-shadow-color="#00000000" class="ele-a160ebb9-189f-4350-b467-2689abf84e5e"> 
            <div class="ele-wrapper ele-wrapper-706a76c9-3924-4706-aae2-a0cdfc54572a">
      <hm-ant-bg-text text="仅支持xls、xlsx格式文件  " font-size="16px"> 
       
    </hm-ant-bg-text>
    </div> 
            <div class="ele-wrapper ele-wrapper-afbfba92-716b-4ef9-8bc8-ccafb793fe73">
      <hm-ant-button text="下载模板" :type="'link'" icon="fa fa-paperclip" @click="onEleafbfba92716B4Ef98Bc8Ccafb793Fe73Click" class="ele-afbfba92-716b-4ef9-8bc8-ccafb793fe73"> 
...
export default {
  ...
  "storeFilter": {
    "config": {
      ...
      "search": {
        ...
        "events": {
          "@click": function(e) {searchStore(self, null);}
        },
        "validator": function(value) {}
      },
      "reset": {
        ...
        "events": {
          "@click": function(e) {self.$refs.storeFilter.reset();searchStore(self, null);}
        },
        "validator": function(value) {}
      }
    },
  ...
  self.getQrCode = async function(id, name) {
    ...
    let variableToEncode = `${self.$accessAddress}` + 'pages/haomo/1751895267671543809/page?storeId=' + `${id}`;
    let titele = `${name}`;
...
downloadImagesAsZip(base64Images);
  ...
  this.$downloadFile("门店列表模板.xlsx", "/api/dkn/store/downExcelTemplate", {})
}
  }
};
</script>
