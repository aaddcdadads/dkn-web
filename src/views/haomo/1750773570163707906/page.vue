<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-button ref="bathqiyong" text="批量启用" :type="'primary'" icon="fa fa-toggle-on" class="ele-bathqiyong"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-batchBisabled">
      <hm-ant-button ref="batchBisabled" text="批量禁用" :type="'primary'" icon="fa fa-toggle-off" class="ele-batchBisabled"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-batchDelete">
      <hm-ant-button ref="batchDelete" text="批量删除" :type="'primary'" icon="fa fa-trash" class="ele-batchDelete"> 
      ...
      <hm-modal ref="batchEdit" title="批量操作" v-model:visible="batchEdit.visible" width="320px" :z-index="1000" height=""> 
            <div class="ele-wrapper ele-wrapper-4cf2a6f1-df2d-4f29-a723-e430c9b53e51">
      <hm-ant-bg-text class="ele-4cf2a6f1-df2d-4f29-a723-e430c9b53e51"> 
