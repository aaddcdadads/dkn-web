<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-bg-card width="100%" height="" border-radius="" padding="" box-shadow-color="#00000000" class="ele-b26f83d8-788d-4911-b39c-d6db12ade907"> 
            <div class="ele-wrapper ele-wrapper-f087f9b5-c006-41c6-aea1-a22f650dcce6">
      <hm-ant-button text="新增门店" :type="'primary'" icon="fa fa-plus" @click="onElef087F9B5C00641C6Aea1A22F650Dcce6Click"> 
      ...
      <hm-ant-button text="导出核销码" :type="'primary'" icon="fa fa-download"> 
      ...
      <hm-modal ref="storeDetailModal" title="查看详情" v-model:visible="storeDetailModal.visible" :ok-button-boole="false" cancel-text="导出门店二维码" :cancel-button-props="false" width="600px" :z-index="1000" height="100%" class="ele-storeDetailModal"> 
      ...
      <hm-ant-bg-text text="二维码：" class="ele-6a427e0a-e088-4f10-8f90-062dff49940b"> 
            ...
            <div class="ele-wrapper ele-wrapper-216245a7-7953-4399-b2b2-43033411ee88">
      <hm-image width="260" height="260"> 
       
    </hm-image>
    </div> 
            <div class="ele-wrapper ele-wrapper-9babf229-dc69-4618-aee1-3b697b5baf99">
      <hm-ant-bg-text text="门店名称" class="ele-9babf229-dc69-4618-aee1-3b697b5baf99"> 
       
    </hm-ant-bg-text>
    </div> 
            <div class="ele-wrapper ele-wrapper-storeDetailForm">
      <hm-ant-formily ref="storeDetailForm" :config="storeDetailForm.config" v-model:value="storeDetailForm.value" :col-num="2" :col-min-width="380" :schema="storeDetailForm.schema" :label-col="7" :wrapper-col="14" class="ele-storeDetailForm"> 
       
    </hm-ant-formily>
    </div> 
    </hm-bg-card>
    </div> 
            <div class="ele-wrapper ele-wrapper-7949a660-4484-4c26-a4e8-523103441b56">
      <hm-bg-card width="100%" height="" border-radius="" :text-align="'right'" padding="12" box-shadow-color="#00000000" class="ele-7949a660-4484-4c26-a4e8-523103441b56"> 
            <div class="ele-wrapper ele-wrapper-daochuButton">
      <hm-ant-button ref="daochuButton" text="导出门店二维码" :type="'primary'" :size="'large'" class="ele-daochuButton"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-704ae18e-b0b5-497f-8b08-b95ffcabf7ba">
      <hm-ant-button text="确定" :type="'primary'" :size="'large'" class="ele-704ae18e-b0b5-497f-8b08-b95ffcabf7ba"> 
