<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-formily ref="registrationOrdersFilter" :schema="registrationOrdersFilter.schema" :wrapper-col="14" :col-num="3" :label-col="7" :col-min-width="380" :config="registrationOrdersFilter.config" v-model:value="registrationOrdersFilter.value" class="ele-registrationOrdersFilter"> 
