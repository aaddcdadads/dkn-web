<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-button ref="actionQueRenBuntton" text="确认" class="ele-actionQueRenBuntton"> 
      ...
      <hm-modal ref="registrationOrdersDeleteModal" title="核销" v-model:visible="registrationOrdersDeleteModal.visible" :closable="true" ok-text="确认" :ok-type="'danger'" width="320px" :z-index="1000" height="80px"> 
