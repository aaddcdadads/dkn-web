<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-formily ref="registrationOrdersFilter" :config="registrationOrdersFilter.config" v-model:value="registrationOrdersFilter.value" :col-num="2" :schema="registrationOrdersFilter.schema" :label-col="7" :wrapper-col="14" class="ele-registrationOrdersFilter"> 
       
    </hm-ant-formily>
    </div> 
            <div class="ele-wrapper ele-wrapper-addButton">
      <hm-ant-button ref="addButton" text="新增" :type="'primary'" icon="fa fa-plus" @click="onAddButtonClick" class="ele-addButton"> 
...
export default {
  ...
  "registrationOrdersTable": {
    ...
    "url": "/api/restify/registrationOrders/list",
    "params": {
      "databaseId": "",
      "column": "createTime",
      "order": "desc"
