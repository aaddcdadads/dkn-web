  ...
  "registrationOrdersTable": {
    ...
    "columns": [
      ...
      },
      {
        ...
        const startTimepick = self.$moment(item.record.pickUpStartTime,"YYYY-MM-DD HH:mm:ss");
        const endTimepick = self.$moment(item.record.pickUpEndTime,"YYYY-MM-DD HH:mm:ss");
        var statusFlag=item.record.paymentStatus===0 && item.record.pickUpStatusText == "待核销" && currentTimepick.isBetween(startTimepick, endTimepick) ?
              0:1;
