<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-bg-card width="100%" height="" border-radius="" padding="" box-shadow-color="#00000000" class="ele-fed9455d-a15f-480a-a6e4-2499063d39a0"> 
      ...
      <hm-ant-select ref="activitySelect" v-model:value="activitySelect.value" url="/api/dkn/activity/list" :params="activitySelect.params" :data-map="activitySelect.dataMap" title="活动" placeholder="选择活动" v-model:options="activitySelect.options" @change="onActivitySelectChange" class="ele-activitySelect"> 
