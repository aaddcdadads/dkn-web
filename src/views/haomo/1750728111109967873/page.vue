<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-formily ref="registrationOrdersFilter" :config="registrationOrdersFilter.config" v-model:value="registrationOrdersFilter.value" :col-num="5" :col-min-width="380" :schema="registrationOrdersFilter.schema" :label-col="7" :wrapper-col="14" class="ele-registrationOrdersFilter"> 
      ...
      <hm-panel height="" title="报名列表" class="ele-acb9ca38-a2dc-4615-8ff9-d19194092922"> 
        ...
        <div class="ele-wrapper ele-wrapper-fed9455d-a15f-480a-a6e4-2499063d39a0">
      <hm-bg-card width="100%" height="30px" border-radius="" padding="" box-shadow-color="#00000000" class="ele-fed9455d-a15f-480a-a6e4-2499063d39a0"> 
      ...
      <hm-ant-button ref="bacthHeImportButton" text="批量核销" :type="'primary'" @click="onBacthHeImportButtonClick" class="ele-bacthHeImportButton"> 
...
//  this.selectTempArr = item.selectedRows;
    ...
    let selectPropertyArr = item.selectedRows.filter(item => item.paymentStatus ===0 || item.paymentStatus ===2 )
