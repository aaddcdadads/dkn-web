<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-formily ref="registrationOrdersFilter" :config="registrationOrdersFilter.config" v-model:value="registrationOrdersFilter.value" :col-num="4" :col-min-width="380" :schema="registrationOrdersFilter.schema" :label-col="7" :wrapper-col="14" class="ele-registrationOrdersFilter"> 
      ...
      <hm-panel height="" title="报名列表" class="ele-acb9ca38-a2dc-4615-8ff9-d19194092922"> 
...
export default {
    ...
    "columns": [
      ...
      },
      {
        ...
        "customRender": function (item) {
               ...
               var anotherDate = self.$moment(item.record.acPickUpTime, 'YYYY-MM-DD HH:mm:ss');
              var statusFlag=item.record.paymentStatus===0 && item.record.pickUpStatusText == "待核销" && currentDate.isBefore(anotherDate) ?
              0:1;
  ...
  console.log("this.registrationOrdersDetailForm.config", "this.userTotalText.text")
