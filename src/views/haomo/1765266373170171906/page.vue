<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-button text="添加" :type="'primary'" icon="fa fa-plus" class="ele-277cb52c-4cb2-4fd3-9725-2aac9220c5be"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-activityPickUpModal">
      <hm-modal ref="activityPickUpModal" title="奖品图片" v-model:visible="activityPickUpModal.visible" :z-index="1000" :auto-close="false" class="ele-activityPickUpModal"> 
            <div class="ele-wrapper ele-wrapper-35179c1e-5e52-4ea0-b218-73c4ab6b0d2e">
      <hm-ant-formily :config='{"sortNo":{"style":{"width":"100%"},"type":"InputNumber","title":"奖品排序","required":true,"props":{"placeholder":"奖品序号"}},"imgPath":{"style":{"width":"100%"},"type":"UploadImage","title":"奖品图片","required":true,"props":{"action":"/api/sys/common/upload","accept":".jpg,.png"}},"name":{"style":{"width":"100%"},"type":"Input","title":"奖品名称","required":true,"props":{"placeholder":"请输入奖品名称"}}}' :value='{}' :col-num="0" :col-min-width="380" :schema='{"type":"object","properties":{"form":{"x-component":"Form","x-component-props":{"wrapper-col":{"span":14},"label-col":{"span":7},"style":{"flexWrap":"wrap","display":"flex"}},"type":"void","properties":{}}}}' :label-col="7" :wrapper-col="14"> 
       
    </hm-ant-formily>
    </div> 
    </hm-modal>
    </div> 
            <div class="ele-wrapper ele-wrapper-96bb95ad-bddc-4f8d-acc8-0ddcad8a20d4">
      <hm-ant-table :columns='[{"dataIndex":"verificationround","title":"核销轮次","key":"verificationround"},{"dataIndex":"roundname","title":"轮次名称","key":"roundname"},{"dataIndex":"verifiabletime","title":"可核销时间段","key":"verifiabletime"},{"slots":{"customRender":"action"},"dataIndex":"","title":"操作","key":"action"}]' :data='[]' :get-data-map='{"total":"","list":""}' :actions='[{"name":"编辑","icon":"fa fa-pencil","callback":"function (item) {\n                            console.log(\"点击编辑: \", item);\n                        }","type":"link"},{"name":"删除","callback":"function (item) {\n                            console.log(\"点击删除: \", item);\n                        }","type":"link","icon":"fa fa-trash"}]' :is-flat-action="true" :row-class-name='{}'> 
      ...
      <hm-ant-button text="添加" :type="'primary'" icon="fa fa-plus" class="ele-2a08a42c-a92e-46de-8f8d-b5724cfc40ea"> 
            ...
            <div class="ele-wrapper ele-wrapper-32f73ba3-e652-4fd6-856c-d1d40436effc">
      <hm-ant-table :columns='[{"title":"字段名","dataIndex":"field","key":"field","ellipsis":true},{"title":"操作","dataIndex":"","key":"action","slots":{"customRender":"action"}}]' :data='[]' :actions='[{"name":"删除","callback":"function (item) {\n                            console.log(\"点击删除: \", item);\n                        }","type":"link","icon":"fa fa-trash"}]' :is-flat-action="true" :row-class-name='{}'> 
