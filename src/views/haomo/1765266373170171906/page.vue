<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-ant-button text="添加" :type="'primary'" icon="fa fa-plus" class="ele-2a08a42c-a92e-46de-8f8d-b5724cfc40ea"> 
       
    </hm-ant-button>
    </div> 
            <div class="ele-wrapper ele-wrapper-activityDictItemModal">
      <hm-modal ref="activityDictItemModal" title="核销轮次" v-model:visible="activityDictItemModal.visible" :z-index="1000" :auto-close="false" class="ele-activityDictItemModal"> 
            <div class="ele-wrapper ele-wrapper-91312d06-7e71-4f82-aa7d-d5aa529de511">
      <hm-ant-formily :value='{}' :col-num="0" :col-min-width="380" :label-col="7" :wrapper-col="14"> 
