...
this.activityPickUpModal.visible = false
  ...
  if (self.activityDictItemStatus === 1) {
    const i = self.$refs.activityDictItemTable.cData.findIndex((e) => e.sysDictItemId === item.sysDictItemId)
    if (i != -1) {
    ...
    const i = self.$refs.activityDictItemTable.cData.findIndex((e) => e.sysDictItemId === item.sysDictItemId)
    if (i != -1 && self.activityDictItemTableItem.sysDictItemId !== item.sysDictItemId) {
      self.$message.error("配置项已存在")
      return
    }
    if (self.activityDictItemTableItem.index || self.activityDictItemTableItem.index == 0) {
      self.$refs.activityDictItemTable.cData.forEach((e, index) => {
