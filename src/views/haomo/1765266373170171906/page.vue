<template>
  <div class="page card">
    <div class="page-wrapper">
      ...
      <hm-modal ref="addprize" title="奖品图片" v-model:visible="addprize.visible" :z-index="1000" :auto-close="false" @ok="onAddprizeOk" @cancel="onAddprizeCancel" class="ele-addprize"> 
            <div class="ele-wrapper ele-wrapper-addActivityImgFormTwo">
      <hm-ant-formily ref="addActivityImgFormTwo" :config="addActivityImgFormTwo.config" v-model:value="addActivityImgFormTwo.value" :col-num="0" :col-min-width="380" :schema="addActivityImgFormTwo.schema" :label-col="7" :wrapper-col="14"> 
      ...
      <hm-modal ref="activityDictItemModal" title="核销轮次" v-model:visible="activityDictItemModal.visible" :z-index="1000" :auto-close="false" @ok="onActivityDictItemModalOk" @cancel="onActivityDictItemModalCancel" class="ele-activityDictItemModal"> 
            <div class="ele-wrapper ele-wrapper-activityDictItemForm">
      <hm-ant-formily ref="activityDictItemForm" :config="activityDictItemForm.config" v-model:value="activityDictItemForm.value" :col-num="0" :col-min-width="380" :label-col="7" :wrapper-col="14"> 
